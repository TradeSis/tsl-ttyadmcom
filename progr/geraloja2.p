...
repeat :
    ...
    /* LINHA ADICIONADO POR CASSIO PARA GERAR OS ESTABELECIMENTOS */
    varqsai = vcaminho + "/" + "estab.d".
    
    disp " Aguarde, Gerando ESTABELECIMENTOS ....." with frame f-mmm
    ...
    output to value(varqsai).
    for each tipmov where tipmov.movtdc = 05 or
                          tipmov.movtdc = 06 or
    ...
    disp " Aguarde, Gerando CONTNF ....." with frame f-mmm
        centered 1 down no-labels no-box color messages. pause 0.
