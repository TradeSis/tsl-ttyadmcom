...
for each wmovim break by wmovim.pronom:
  ...
  put unformatted
      ...
      (movim.movqtm * movim.movpc)  to 145 format ">>>,>>9.99"
  ...
  DO:
    ...
    put unformatted skip(2)
        ...
        plani.bsubst        at 85 format "zzz,zz9.99"
        plani.icmssubst     at 115 format "zzz,zz9.99"
        plani.protot        at 140 format "zzz,zz9.99" skip(1)
        plani.frete         at 20 format "zzz,zz9.99"
        plani.seguro        at 50 format "zzz,zz9.99"
        plani.ipi           at 115 format "zzz,zz9.99"
