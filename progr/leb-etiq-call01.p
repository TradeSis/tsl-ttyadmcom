...
if sresp then do:
    if opsys = "UNIX" then do:
        vdir = "/admcom/zebra/01/".
        varquivo = vdir + "eti-01.bat".
        ...
        put unformatted "zip -q " vdir 
                "01.zip c*.* eti-01.bat *.GRF PKUNZIP.EXE UZIPA-01.BAT".
    ...
    for each tt-etiq:
        run leb-etiq-imprime01.p (input tt-etiq.rec,
                                input tt-etiq.qtd,
    ...
    if opsys = "UNIX" then unix silent value("/admcom/zebra/01/zipa.sh").
end.
