...
if program-name(2) <> "pre_nfe_5202.p" and
   program-name(2) <> "manager_nfe ileb/gera-devol.p" /* P2k - Data Hub */
...
for each I01_Prod of A01_infnfe by I01_Prod.xprod[1]:
    ...
    /*
    if I01_Prod.cEAN <> "" and I01_Prod.cEAN <> "GTIN-8"
    then geraxml("T5","T5","cEAN",I01_Prod.cEAN).
    ...
    */
    ...
    /*
    if I01_Prod.cEANtrib <> "" and I01_Prod.cEAN <> "GTIN-8"
    then geraxml("T5","T5","cEANTrib",I01_Prod.cEANtrib).
    ...
    */
    ...
    if I01_Prod.cfop = 5603
    then geraxml("T5","T5","indTot", "0").
    else geraxml("T5","T5","indTot", "1").    
    ...
    then do:         
        ...
        then do:
            ...
            geraxml("T7","T7","vBC",
                            topto(string(N01_icms.vbc,"zzzzzzzzzzzz9.99"))).
            geraxml("T7","T7","pICMS", topto(string(N01_icms.picms,"zz9.99"))).
            geraxml("T7","T7","vICMS",
                            topto(string(N01_icms.vicms,"zzzzzzzzzzzz9.99"))).
        ...
        then do:
            ...
            geraxml("T7","T7","vBC",
                            topto(string(N01_icms.vbc,"zzzzzzzzz9.99"))).
            if N01_icms.predbc > 0
            then geraxml("T7","T7","pRedBC",string(N01_icms.predbc,"zzz9.99")).
            geraxml("T7","T7","pICMS",
                            topto(string(N01_icms.picms,"zzzzzzzzz9.99"))).
            geraxml("T7","T7","vICMS",
                            topto(string(N01_icms.vicms,"zzzzzzzzz9.99"))).
