...
def var vespecie  as char format "x(10)".
...
if E01_Dest.xpais <> ""
then do:
    geraxml("T5","T5","cPais",string(E01_Dest.cpais)).
    geraxml("T5","T5","xPais",E01_Dest.xpais).
end.
...
assign vcont-pro-aux = 1000000.

for each i01_prod of a01_infnfe exclusive-lock by I01_Prod.xprod[1].
...
for each I01_Prod of A01_infnfe by I01_Prod.xprod[1]:
    ...
    ****/
    ...
    /*** IMPORTACAO  ***/
                    geraxml("T5","","DI","").
                    geraxml("T6","T6","nDI","1315941963").
   
                    geraxml("T6","T6","dDI","2013-08-15").
                    geraxml("T6","T6","xLocDesemb",
               "AEROPORTO INTERNAC. SALGADO FILHO-INFRAERO-PORTO ALEGRE/RS").
                    geraxml("T6","T6","UFDesemb","RS").
            
                    geraxml("T6","T6","dDesemb","2013-08-28").
                    geraxml("T6","T6","cExportador","203120").
            ...
            then do:
                ...
                then do: 
                    ...
                    ***/
                    ...
                    geraxml("T6","","adi","").
                    geraxml("T7","T7","nAdicao","001").
                    geraxml("T7","T7","nSeqAdic","001").
                    geraxml("T7","T7","cFabricante","115110").
                    geraxml("","T6","adi","").
    ...
    geraxml("T6","T6","cEnq","999").
    
    geraxml("T6","","IPITrib","").
    
    geraxml("T7","T7","CST","00").
    geraxml("T7","T7","vBC","2801.21").
    geraxml("T7","T7","pIPI","0.00").
    geraxml("T7","T7","vIPI","0.00").
...
***/
     ...
     */
     ...
     geraxml("T5","","II","").
     geraxml("T6","T6","vBC","2054.00").
     geraxml("T6","T6","vDespAdu","214.50").
     geraxml("T6","T6","vII","328.64"). 
     geraxml("T6","T6","vIOF","0.00").
     geraxml("","T5","II","").
