...
def temp-table wrevi-produ no-undo
    ...
    field   movpc           as dec extent 12 format ">>>,>>9.99"
    field   movqtm          as dec extent 12 format ">>>,>>9.99".
...
v-data-aux <= date((int(month(brevista.datfim))),01,
    ...
    for each estab no-lock:
     ...
     do v-data-mov = vd1 to vd2 :
       ...
       disp estab.etbcod v-data-mov with 1 down row 10 centered no-box no-label~s. pause 0. 
           ...
           for each movim where movim.etbcod = plani.etbcod and
                ...
                do j = 1 to 12:
                    ...
                    then do:
                     ...
                     wrevi-produ.movqtm[j] = wrevi-produ.movqtm[j] + 
                     movim.movqtm.
                     
                     wrevi-produ.movpc[j]  = wrevi-produ.movpc[j] + 
...
DISPLAY "QUANTIDADE VENDIDA" with frame f-titulo1.

for each wrevi-produ :

            assign  v-valm-01 = wrevi-produ.movqtm[1]
                    v-valm-02 = wrevi-produ.movqtm[2]
                    v-valm-03 = wrevi-produ.movqtm[3]
                    v-valm-04 = wrevi-produ.movqtm[4]
                    v-valm-05 = wrevi-produ.movqtm[5]
                    v-valm-06 = wrevi-produ.movqtm[6]
                    v-valm-07 = wrevi-produ.movqtm[7]
                    v-valm-08 = wrevi-produ.movqtm[8]
                    v-valm-09 = wrevi-produ.movqtm[9]
                    v-valm-10 = wrevi-produ.movqtm[10]
                    v-valm-11 = wrevi-produ.movqtm[11]
                    v-valm-12 = wrevi-produ.movqtm[12].
...
DISPLAY skip(2). 
DISPLAY "VALORES VENDIDOS" with frame f-titulo2.

for each wrevi-produ :

            assign  v-valm-01 = wrevi-produ.movpc[1]
                    v-valm-02 = wrevi-produ.movpc[2]
                    v-valm-03 = wrevi-produ.movpc[3]
                    v-valm-04 = wrevi-produ.movpc[4]
                    v-valm-05 = wrevi-produ.movpc[5]
                    v-valm-06 = wrevi-produ.movpc[6]
                    v-valm-07 = wrevi-produ.movpc[7]
                    v-valm-08 = wrevi-produ.movpc[8]
                    v-valm-09 = wrevi-produ.movpc[9]
                    v-valm-10 = wrevi-produ.movpc[10]
                    v-valm-11 = wrevi-produ.movpc[11]
                    v-valm-12 = wrevi-produ.movpc[12].
