...
def new global shared var f-etbcod as int.
def new global shared var f-codprof as int.
...
def var esqcom1         as char format "x(12)" extent 5
    initial [" Inclusao "," Alteracao ","   Renda",""].
        ...
        then do:
            ...
            then do:
                ...
                then do with frame f-profissao on error undo.
                    ...
                    profissao.profdesc = fn-tira-acento(profissao.profdesc).
                ...
                if esqcom1[esqpos1] = "   Renda "
                then do:
                    f-etbcod = ?.
                    f-codprof = profissao.codprof.
                    run cadrenda.p.
                    f-etbcod = ?.
                    f-codprof = ?.
                end.
