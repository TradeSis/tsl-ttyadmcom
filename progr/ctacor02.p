/* 
Rafael Antunes 17/01/2013
Programa Identico ao /admcom/progr/ctacor01.p
Porem Filtrando contacor.campo3[1] = "EST" 
*/
...
for each tt-lj no-lock:
    for each func where func.etbcod = tt-lj.etbcod no-lock:
        ...
        for each contacor where
            ...
            assign
                tt-conta.licred = tt-conta.licred + contacor.valcob
                .
        end.
        */
    end.
...
for each tt-conta:
    tt-conta.saldo = tt-conta.debito - tt-conta.credito.
...
def var varquivo as char.
    ...
    {mdadmcab.i &Saida     = "value(varquivo)"   
                ...
                &Nom-Rel   = ""ctacor01"" 
                &Nom-Sis   = """ RH """ 
                &Tit-Rel   = """ CONTA CORRENTE CONSULTORES - SOMENTE TIPO EST""" 
                &Width     = "120"
                &Form      = "frame f-cabcab"}
