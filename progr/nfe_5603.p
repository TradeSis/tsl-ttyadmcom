...
def shared temp-table tt-nfref3 like plani.
        ...
        for each tt-movim where tt-movim.etbcod = tt-plani.etbcod and
            ...
            then do:
                ...
                assign
                    ...
                    /*I01_Prod.infadprod*/ 
                    I01_Prod.cprod = "CFOP" + string (tt-plani.opccod)
                     /* string(tt-movim.procod )*/
                    /*I01_Prod.cean*/ 
                    I01_Prod.xprod = "Ressarcimento de ICMS"
...
then do:
    create tt-nfref3.
    buffer-copy tt-plani to tt-nfref3.
