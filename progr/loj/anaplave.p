...
def var vimprimir as log format "PDF/Tela".
           ...
           for each com.plani use-index pladat 
              ...
              valtotal = 0.
               ...
               then do:
                   ...
                   assign tt-ven.valor   = tt-ven.valor + 
                        if com.plani.biss <> ? then com.plani.biss
                            else 0
...
/*        end.*/
    ...
    form 
       ...
       with frame ff.
    if opsys = "UNIX"
    then varquivo = "/admcom/relat/anaplave" + string(time).
    else varquivo = "l:\relat\anaplave" + string(month(today)).
  ...
  assign val_acr = 0
    ...
    for each tt-plano break by tt-plano.etbcod
        ...
        if avail tabaux
            ...
            or tt-plano.fincod = 98
            or tt-plano.fincod = 70
            or tt-plano.fincod = 79
            or tt-plano.fincod = 69
            or tt-plano.fincod = 80
            or tt-plano.fincod = 100**********/
        then do:
       ...
       then do:
            ...
            pct = ((tt-total-ven.valor / tt-total-ven.biss) * 100).
            if pct = ? then pct = 0.
            mpct = ((tt-total-ven.acr / tt-total-ven.venda) * 100).
            if mpct = ? then mpct = 0.
        ...
        (vdec-tot-plan-bis * 100 / tt-total-ven.valor) format ">>9.99" at 58
                    no-label
                  "%" at 65
                                                 with frame f02  .
    ...
    then do:
        ...
        then run visurel.p (input varquivo, input "").
            ...
            run pdfout.p (input varquivo,
                          ...
                          input "anaplave-" + string(time) + ".pdf",
                          input "Portrait",
                          input 8.0,
                          input 1,
                          output vpdf).
