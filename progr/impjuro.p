...
def var vano          as int.
    ...
    unix silent 
    /usr/dlc/bin/quoter -d % /admcom/relato/drebes/CONT2001/JURO2001.TXT > 
                    /ctb-dados/juro2001.arq.

 
    
    input from /ctb-dados/juro2001.arq.
    repeat:
        import varq.
        ...
        assign diario.juro        = valor-credito.
