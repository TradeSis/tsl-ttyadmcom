        ...
        for each contrato where contrato.etbcod = tt-estab.etbcod 
            ...
            */
            ...
            then do:
                ...
                assign 
                   tt-contrato.valorav = vtotalav - tt-contrato.vlentra
                   tt-contrato.valorto = contrato.vltotal - contrato.vlseguro
                   tt-contrato.numparc = 0
                   tt-contrato.valacre = contrato.vltotal - contrato.vlseguro 
                                         - tt-contrato.valorav 
                   tt-contrato.pctsst = 0
                   tt-contrato.modcod = contrato.modcod
                   tt-contrato.loja = contrato.etbcod 
                   tt-contrato.produto = 5
                   tt-contrato.vlseguro = 0 /*contrato.vlseguro*/
                   .
    ...
    for each tt-contrato where
        ...
        ***/
        ...
        for each btitulo where 
                           ...
                           btitulo.titdtven > contrato.dtinicial
                       no-lock.
             if btitulo.titdtven <> btitulo.titdtemi
