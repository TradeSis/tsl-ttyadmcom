...
procedure relatorio-analitico-FAIXA:
    ...
    */
    ...
    put "Codigo;Nome;CPF;Contrato;Valor;Emissao;Vencimento_inicial;"
        "Vencimento_final;Risco"
                    skip.
    ...
    for each visdev19 where visdev19.data_visao = vdatref  and
        ...
        then do:
            ...
            output to value(varq).
            put "Codigo;Nome;CPF;Contrato;Valor;Emissao;Vencimento_inicial;Venc~imento_final;Risc o Cliente;Riscao"
            skip.
    ...
    for each visdev19 where visdev19.data_visao = vdatref  and
        ...
        ***/
        vtotal = vtotal + total_vencido + total_vencer.
    end. 
    end.
    else do:
    for each visdev19 where visdev19.data_visao = vdatref  and
...
procedure relatorio-analitico-GERAL:
    ...
    */
    ...
    /*message vdatref vtipo_visao vcobcod. pause.
     */
