        ...
        hide frame frame-a no-pause.
          ...
          then do:
            ...
            then do:
                ...
                output to printer.
                display 
                "LISTAGEM DE CONFIRMACAO DE FILIAIS - FILIAL" 
                 vetb no-label
                    " DIA " today format "99/99/9999"
                        with frame f-cab centered.
                ...
                for each tt-plani:
                    ...
                    if (plani.etbcod >= 990 or
                           {conv_igual.i plani.etbcod})or
                       (plani.desti >= 990 
                           or plani.dest = 993 
                           or plani.dest = 995
                           or plani.dest = 900
