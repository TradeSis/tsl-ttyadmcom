    ...
    */
    ...
    repeat:
        ...
        **/
        ...
        for each wpag where wpag.wmodcod <> "" :
            find modgru where 
...
if sfuncod = 101
then do:
output to ./tt-titulo-grupo-cl.txt.
for each tt-titulo.
...
procedure fin-titudesp:
    ...
    for each titudesp where titudesp.empcod = wempre.empcod and
                    ...
                    if not can-find (first tt-estab
                                     where tt-estab.etbcod = titudesp.etbcod)                   then next.
                    ...
                    /*
                    if titudesp.modcod = "MME"
                    then do:
                        vacumme = vacumme + titudesp.titvlpag.
                    end.
                    */
                    /**/
                    ...
                    assign
                tt-titulo.titvlcob = tt-titulo.titvlcob + titudesp.titvlcob
                tt-titulo.titvlpag = tt-titulo.titvlpag + titudesp.titvlpag
                .
    end.
