...
if opsys = "UNIX"
then do:
    output to /admcom/zebra/sc/eti-sc.bat append.
    ...
    output to l:~\zebra~\sc~\eti-sc.bat append.
    ...
    */
    ...
    then do:
      for each wfetq break by linha:
        ...
        if opsys = "UNIX"
        then varquivo = "/admcom/zebra/sc/c" + string(produ.procod)
                               + "." + trim(string(par-taman,"x(3)")).
        else varquivo = "l:~\zebra~\sc~\c" + string(produ.procod) 
                       + "." + trim(string(par-taman,"x(3)")).
        output to value(varquivo). 
        
        /*
        output to value("l:\zebra\sc\c" + string(produ.procod) 
                       + "." + string(par-taman,"x(3)")).
        */
            for each wfetq break by linha.
        ...
        output close.
        if opsys = "UNIX"
        then varquivo = "/admcom/zebra/sc/eti-sc.bat".
        else varquivo = "l:~\zebra~\sc~\eti-sc.bat".
    ...
    then do:
      for each wfetq break by linha:
        ...
        if opsys = "UNIX"
        then varquivo = "/admcom/zebra/sc/cr" + string(produ.procod) + 
                            "." + trim(string(par-taman,"x(3)")).
        else varquivo = "l:~\zebra~\sc~\cr" + string(produ.procod) +
                            "." + trim(string(par-taman,"x(3)")).
        output to value(varquivo).  
        /*
                output to value("l:\zebra\sc\cr" 
                       + string(produ.procod) 
                       + "." + string(par-taman,"x(3)")).
        */
        for each wfetq break by linha.
        ...
        output close.
        if opsys = "UNIX"
        then varquivo = "/admcom/zebra/sp/eti-sp.bat".
        else varquivo = "l:~\zebra~\sp~\eti-sp.bat" .
        output to value(varquivo) append.
        /*
        output to l:\zebra\sc\eti-sc.bat append.
        */
