/*
*
*    pdvmoe.p    -    Esqueleto de Programacao    com esqvazio
*
*/
{admcab.i}
...
def buffer bpdvmoeda       for pdvmoeda.
...
repeat:
    ...
    then do.
        message "Sem pdvmoeda" view-as alert-box.
        leave.
    end.
    else esqvazio = no.
    ...
    repeat with frame frame-a:
        ...
        then do:
            ...
            status default "".
            run color-message.
            choose field pdvmoeda.sequencia help ""
            ...
            then do:
                ...
                if not avail pdvmoeda
                then next.
                color display white/red pdvmoeda.sequencia with frame frame-a.
                if frame-line(frame-a) = frame-down(frame-a)
        ...
        then do:
            ...
            then do:
                ...
                then do with frame f-pdvmoeda.
                    disp pdvmoeda.
                    disp pdvmoeda.cmocod format ">>>>>>".
                end.
            end.
            else do:
...
procedure frame-a.
    find cmon of pdvmoeda no-lock no-error.
    display
        pdvmoeda.etbcod column-label "Etb"
        pdvmoeda.datamov
