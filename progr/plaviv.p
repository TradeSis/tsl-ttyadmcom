...
repeat:
    ...
    then do:
        ...
        do with frame f-inclui1  overlay row 6  centered side-labels.
            create plaviv.
                update plaviv.tipviv    label "Promocao." format ">>>9".
                find promoviv where
                ...
                update plaviv.procod    label "Celular.." .
                ...
                update
                       plaviv.modelo    label "Modelo..." skip
                       plaviv.pretab    label "Pc.Tabe.." skip
        ...
        hide frame frame-a no-pause.
          ...
          then do:
            ...
            then do with frame f-altera overlay row 6 centered side-labels.
                ...
                find promoviv where
                     promoviv.tipviv = plaviv.tipviv no-lock no-error.
                disp plaviv.tipviv  label "Promocao." format ">>>9"
                ...
                disp plaviv.codviv  label "Plano...." format ">>>9"
                     ...
                     at 21 skip.
                find produ where produ.procod = plaviv.procod no-lock no-error.
                disp plaviv.procod  label "Celular.."
                     produ.pronom no-label when avail produ 
                     at 21 skip.
                disp plaviv.modelo    label "Modelo..." skip
                     plaviv.pretab    label "Pc.Tabe.." skip
                     plaviv.prepro    label "Pc.Prom.." skip
                     plaviv.dtini     label "Dt.Inicio" skip
                     plaviv.dtfin     label "Dt.Final." skip
                ...
                /***
                update plaviv.tipviv    label "Promocao." .
                find promoviv where
                     promoviv.tipviv = plaviv.tipviv no-lock no-error.
