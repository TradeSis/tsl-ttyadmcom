                ...
                /* #3 - regra esta correta */                    
                    ...
                    then do:
                        ...
                        then do:
                            ...
                            else tt-etbtit.nov     = tt-etbtit.nov    + titulo.titvlcob.
                        end.                           
                        else
                    ...
                    then do:
                        ...
                        then do:
                            ...
                            else tt-etbtitfeirao.nov    = tt-etbtitfeirao.nov    + titulo.titvlcob.
                        end.    
                    end.
...
for each wfano where vano > (year(vdtref) + 1) break by vano:
    ...
    for each tt-etbtit where tt-etbtit.titvlcob <> 0:
        ...
        disp tt-etbtit.etbcod
             ...
             tt-etbtit.titvlcob(total) column-label "(1+2+3+4+5)!Total"
              /* #1 */
             ...
             tt-etbtit.cre (total) column-label "(5)!Venda"
             wcrenov (total) column-label "(3+4+5)!Carteira"
            /* #1 */
             with frame f-dispp down width 160.
