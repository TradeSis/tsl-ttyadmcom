...
def var vnumero-pla like plani.numero.
    ...
    then do:
            ...
            ****/
             ...
             then assign iestcusto = round(estoq.estcusto,2)
                         iestatual = /*sal-atu*/ estoq.estatual.
             ...
             then do:
                     ...
                     assign tt-inv.clacod   = produ.clacod
                            ...
                            tt-inv.estcusto = 
                            string((iestcusto * 100),"->>>>>>>99")                            tt-inv.estatual = 
                            string((iestatual),"->>>>>9")
                ...
                **/
                     ...
                     then do:
                            ...
                            assign tt-inv.clacod   = produ.clacod
                                   ...
                                   tt-inv.pronom   = 
                                   string(produ.pronom,"x(50)")
                                   tt-inv.prounven = 
                                   string(produ.prounven,"x(03)")
                                   tt-inv.estcusto = 
                                   string((iestcusto * 100),"->>>>>>>99") 
                                   tt-inv.estatual = 
                                   string((iestatual),"->>>>>9")
                                   tt-inv.catcod   = produ.catcod.
...
procedure pi-sele5:
    ...
    update vnumero-pla  label "Nota Fiscal  " skip 
                    with frame f-inf2  .
