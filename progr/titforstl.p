...
def shared var vmodcod         like banfin.titulo.modcod initial "DUP".
...
/*                run tipo-documento. */
    ...
    repeat:
        ...
        display banfin.titulo.titnum
                ...
                banfin.titulo.titvlpag format "->>,>>9.99" 
                when banfin.titulo.titvlpag > 0
                banfin.titulo.titvljur format "->>,>>9.99"
                banfin.titulo.titvldes
                banfin.titulo.titsit 
    ...
    repeat with frame frame-a:
       ...
       then do with frame fproc centered row 5 overlay color message side-label:
            ...
            find first banfin.titulo where banfin.titulo.empcod   = wempre.empcod and
                                    ...
                                    banfin.titulo.etbcod   = vetbcod       and
                                    banfin.titulo.clifor   = vclifor       and
                                    banfin.titulo.titbanpag = vsetcod      and
                                  banfin.titulo.titnum >= input banfin.titulo.titnum no-error.
...
/*                run tipo-documento. */
            ...
            then do with frame ftitulo:
                ...
                update text(banfin.titulo.titobs) with frame fobs.
                if  banfin.titulo.titvlcob <> vtitvlcob then do:
                   if  banfin.titulo.titvlcob < vtitvlcob then do:
                    assign sresp = yes.
                    display "  Confirma GERACAO DE NOVO banfin.titulo ?"
                    ...
                    if  sresp then do:
                        ...
                        display "  Confirma AUMENTO NO VALOR DO banfin.titulo?"
                ...
                then do on error undo:
                    /*
                    for each zbanfin.titulo use-index titdtven where
                ...
                then do on error undo, retry:
                    ...
                    */
                    ...
                    then do:
                        ...
                        if lancxa.lanhis = 1
                        then lancxa.comhis = banfin.titulo.titnum 
                                + "-" + string(banfin.titulo.titpar)
                                + " " + forne.fornom.
