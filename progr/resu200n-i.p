            ...
            */
            ...
            for each tt-estab,
                ...
                find first tt-plani where
                           tt-plani.etbcod = movim.etbcod and
                           tt-plani.placod = movim.placod and
                           tt-plani.pladat = movim.movdat and
                           tt-plani.movtdc = movim.movtdc
                           no-error.
            ...
            for each tt-estab,
                each tt-movim where tt-movim.procod = produ.procod    and
                                 tt-movim.etbcod = tt-estab.etbcod and
                                 tt-movim.movtdc = 5               and
                                 tt-movim.movdat >= vdti           and
                                 tt-movim.movdat <= vdtf        no-lock:
                
                if tt-movim.movqtm = 0 or
                   tt-movim.movpc  = 0
                then next.
                ...
                find first plani where plani.etbcod = tt-movim.etbcod and
                                       ...
                                       plani.pladat = tt-movim.movdat and
                ...
                val_dev =  ((tt-movim.movpc * tt-movim.movqtm) / plani.platot) *
                                                   plani.vlserv.
                                                   
                val_biss = tt-movim.movtot.
                             
                val_platot = (tt-movim.movpc * tt-movim.movqtm).
                            
                acre = tt-movim.acr-fin.               
                ...
                est-ven = est-ven + tt-movim.movqtm.
                
                if est-ven = ? then est-ven = 0.
                vend-qtd = vend-qtd + tt-movim.movqtm. 
                venda_c  = venda_c + (tt-movim.movqtm * estoq.estcus).
