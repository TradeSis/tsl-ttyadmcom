...
repeat:
    ...
    for each estab where ( if vetbcod = 0
        ...
        for each plani where plani.etbcod = estab.etbcod and
            ...
            totavi = totavi + 1.
            display totavi label "A vista" 
                with frame f-tot1 side-label.
            pause 0.
        end.
        for each contrato where contrato.etbcod = estab.etbcod and
            ...
            totcon = totcon + 1.
            display totcon label "Contratos" 
                    with frame f-tot2 side-label.
            pause 0.
        end.
        for each titulo where titulo.etbcobra = estab.etbcod and
            ...
            then next.
            totpre = totpre + 1.
            display totpre label "Prestacoes" 
                with frame f-tot3 side-label.
            pause 0.
        end.
    ...
    varquivo = "l:\admcom\relat\rel" + STRING(month(vdt1),"99").
    ...
    {mdadmcab.i
        ...
        for each w-demo:
            display w-demo.etbcod column-label "Filial"
                    wavi(total) 
                       column-label "Total A Vista" format ">,>>>,>>9.99"
                    wcon(total) 
