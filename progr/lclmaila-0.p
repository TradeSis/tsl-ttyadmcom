...
def var v-situacli-des as char format "x(20)" extent 11 init
["INATIVO","ATIVO CONTRATO","ATIVO COMPRA PRAZO","ATIVO COMPRA VISTA",
 "RECUPERADO CONTRATO","","RECUPERADO VENDA VISTA",
 "NOVO CADASTRO COMPLETO","NOVO CADASTRO RAPIDO","NOVO COMPRA PRAZO",
 "NOVO COMPRA VISTA"].
...
def var in-plai as log.
def var in-cli as log.
def var in-clii as log.
def var nv-cli as log.
def var nv-clir as log.
...
then do:
    for each clien where clien.clicod > 10 no-lock.
        ...
        assign
            ...
            in-pla = no in-plai = no 
            in-cli = no in-clii = no
            nv-cli = no nv-clir = no
            nv-con = no nv-vvi = no
            .
        ...
        then do:
            ...
            else if in-pla or in-plai or in-cli or in-clii
            then do:
                /*if vachou = no
                then*/ do:
                    ...
                    assign
                        v-situacli-cod = 1  
                        vachou = yes.
                    if in-plai or in-clii
                    then assign
                            vinativosi = vinativosi + 1
                            ttfil.inativosi = ttfil.inativosi + 1.
                    else assign
...
then vtiporel = "ANALITICO".
    ...
    {mdad.i
        ...
        assign
            vtotal = 0 vinativos = 0 vinativosi = 0
        ...
        for each ttfil where ttfil.etbcod <> 0 no-lock break by ttfil.etbcod.
            assign 
                ...
                vinativosi = vinativosi + ttfil.inativosi
        ...
        vtotal = vtotal + vinativos + vinativosi +
        ...
        disp skip (1)
            ...
            "Clientes Inativos 13 a 24...........:" vinativos     skip
            "Clientes Inativos + 24 .............:" vinativosi    skip
            ...
            "Clientes Novos Cadastro Completo....:" vnovos        skip
            "Clientes Novos Cadastro Rapido......:" vnovosr       skip
        ...
        then do:
            for each ttfil where ttfil.etbcod <> 0 no-lock 
                ...
                vtotal = ttfil.inativos + ttfil.inativosi +
                ...
                ttfil.novos + ttfil.novos-con + ttfil.novos-vvi.
                 ...
                 ttfil.inativos    column-label "Total!Inativos!13 a 24" (total)
                 ttfil.inativosi column-label "Total!Inativos!+ 24" (total)
                 ...
                 ttfil.novos  column-label "Novos!Cadastro!Completo"   (total)
                 ttfil.novosr column-label "Novos!Cadastro!Rapido"   (total)
            ...
            for each ttfil no-lock:
                ...
                vtotal          skip
                "Clientes Inativos 13 1 24...........:" format "x(37)"
                ttfil.inativos  skip
                "Clientes Inativos + 24..............:" format "x(37)"
                                ttfil.inativosi  skip
                ...
                "Clientes Novos Cadastro Completo....:" format "x(37)"
                ttfil.novos        skip
                "Clientes Novos Cadastro Rapido......:" format "x(37)"
                ttfil.novosr       skip
                ...
                skip (1)
                with width 130 no-box no-labels.
    ...
    "CLIENTES INATIVOS 13 a 24  = que nao possuem titulos em aberto e nao compram a"
    "                      mais de 1 ano ate 2 anos" skip
         skip 
    "CLIENTES INATIVOS + 24 = que nao possuem titulos aberto e nao compram a"
    "                      mais de 2 ano." skip
    ...
    "                      no periodo informado."
    skip
    "NOVOS COMPLETO      = cadastros completos no periodo sem compra." skip
    "NOVOS RAPIDO        = cadastros rapidos no periodo sem compra."  skip
        ...
        then do:
            ...
            then put unformatted 
                "      ;;Total   ;Clientes;Ativos  ;Ativos      ;Ativos      ;
                 ...
                 Com   ;" skip
                "Filial;;Clientes;Inativos;Inativos + 24;Contrato;Compra Prazo;Compra Vista;
                 Compra Prazo;Compra Vista;Cadastro Completos;Cadastro Rapido;Compra Prazo;Compra Vista;
                 E-mail;" skip.
            ...
            vetbnom skip
            "Total de Clientes...................;" vtotal    skip
            "Clientes Inativos 13 a 24...........;" ttfil.inativos     skip
            "Clientes Inativos + 24..............;" ttfil.inativosi    skip
            ...
            "Clientes Novos Cadastro Completo....;" ttfil.novos        skip
            "Clientes Novos Cadastro Rapido......;" ttfil.novosr       skip
