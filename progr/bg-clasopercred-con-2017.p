...
def temp-table tt-pdvd2017 like pdvd2017.
...
form pdvd2017.Faixa_risco column-label "Faixa" format "x(5)"
     pdvd2017.descricao_faixa no-label format "x(12)"  
     pdvd2017.saldo_curva column-label "Curva"      format ">>>>>>>>9.99"
     pdvd2017.pctprovisao column-label "%"          format ">>>9.99"
     pdvd2017.provisao    column-label "Provisao"   format ">>>>>>>>9.99"
     pdvd2017.principal   column-label "Principal"  format ">>>>>>>>9.99"
     pdvd2017.renda       column-label "Renda"      format ">>>>>>>>9.99"
...
for each pdvd2017 where pdvd2017.data_visao = vdatref     and
                        pdvd2017.tipo_visao = vtpfaixa /*vtipo_visao*/ and
                        pdvd2017.modo_visao = vmodo_visao and
                        pdvd2017.modalidade = "CRE" and
                        pdvd2017.cobcod     = ? and
                        pdvd2017.categoria  = ? and
                        pdvd2017.etbcod = 0
                        no-lock:
    assign
        tsaldo_curva = tsaldo_curva + pdvd2017.saldo_curva
        tprovisao    = tprovisao + pdvd2017.provisao
        tprincipal   = tprincipal + pdvd2017.principal
        trenda       = trenda + pdvd2017.renda
        .                
end.                    
...
l1: repeat:
    ...
    {sklclstb.i  
        ...
        &file  = pdvd2017  
        &help  = " "
        &cfield = pdvd2017.faixa_risco
        &noncharacter = /* */  
        &ofield = " pdvd2017.descricao_faixa
                    pdvd2017.saldo_curva
                    pdvd2017.pctprovisao
                    pdvd2017.provisao
                    pdvd2017.principal
                    pdvd2017.renda
                    "  
        &aftfnd1 = " "
        &where  = " pdvd2017.data_visao = vdatref and
                    pdvd2017.tipo_visao = vtpfaixa  and
                    pdvd2017.modo_visao = vmodo_visao and 
                    pdvd2017.modalidade = ""CRE"" and
                    pdvd2017.cobcod = vcobcod and
                    pdvd2017.categoria = vcatcod and
                    pdvd2017.etbcod = 0 "
        &aftselect1 = " 
                        run aftselect.
...
procedure aftselect:
    ...
    THEN DO:
        sresp = no.
        message 
        "Confirma gerar relatorio analitico faixa" pdvd2017.faixa_risco 
        update sresp.
        if sresp
        then do: 
            /*if vtipo_visao = "CONTABIL"
            then run relatorio-faixa-analitico-outros(pdvd2017.faixa_risco).
            else*/ run relatorio-faixa-analitico(pdvd2017.faixa_risco).
        end.
    END.
...
procedure relatorio:
    ...
    def var vencer90 like pdvd2017.vencer_90 .
    def var vencer360 like pdvd2017.vencer_360.
    def var vencer1080 like pdvd2017.vencer_1080.
    def var vencer1800 like pdvd2017.vencer_1800 .
    def var vencer5400 like pdvd2017.vencer_5400  .
    def var vencer9999 like pdvd2017.vencer_9999   .
    ...
    for each pdvd2017 where 
             pdvd2017.data_visao = vdatref and
             pdvd2017.tipo_visao = vtipo_visao and
             pdvd2017.modo_visao = vmodo_visao and
             pdvd2017.modalidade = "CRE" and
             pdvd2017.cobcod     = vcobcod and
             pdvd2017.categoria  = vcatcod and
             pdvd2017.faixa_risco <> "" no-lock:
        
        /*
        find first tbcntgen where
                   tbcntgen.tipcon = 13 and
                   tbcntgen.campo1[1] = pdvd2017.faixa_risco 
                   no-lock no-error.
        if avail tbcntgen
        then pdvd2017.descricao_faixa = tbcntgen.numini + "-" +
                            tbcntgen.numfim.
        */

        if pdvd2017.faixa_risco < "H"
        then assign
            vencidos = pdvd2017.vencido
            vencer90 = pdvd2017.vencer_90
            vencer360 = pdvd2017.vencer_360
            vencer1080 = pdvd2017.vencer_1080
            vencer1800 = pdvd2017.vencer_1800
            vencer5400 = pdvd2017.vencer_5400 
            vencer9999 = pdvd2017.vencer_9999
            .
        else assign
            vencidos = pdvd2017.vencido +
                       pdvd2017.vencer_90 + pdvd2017.vencer_360 +
                       pdvd2017.vencer_1080 + pdvd2017.vencer_1800 +
                       pdvd2017.vencer_5400 + pdvd2017.vencer_9999
            vencer90 = 0
            vencer360 = 0
            vencer1080 = 0
            vencer1800 = 0
        ...
        disp pdvd2017.faixa_risco column-label "Faixa"
             pdvd2017.descricao_faixa no-label   format "x(12)"
             ...
             format ">>>,>>>,>>9.99"  (total)
             vencer5400 column-label "Vencer!5 a 17 anos"
             format ">>>,>>>,>>9.99"  (total)
             vencer9999 column-label "Vencer!+ 17 anos"
             format ">>>,>>>,>>9.99"  (total)
             pdvd2017.saldo_curva  column-label "Saldo Curva"
             format ">>,>>>,>>>,>>9.99"  (total)
             pdvd2017.provisao  column-label "Provisao"
             format ">>>,>>>,>>9.99"  (total)
             pdvd2017.pctprovisao column-label "%"
             pdvd2017.principal(total) column-label "Principal"
             format ">>>,>>>,>>9.99"
             pdvd2017.renda(total) column-label "Renda"
             format ">>>,>>>,>>9.99"
    ...
    for each fn-risco NO-LOCK:
        ...
        ****/
        ...
        disp fn-risco.risco column-label "Faixa"
             ...
             format ">>>,>>>,>>9.99"  (total)
             fn-risco.ven-5400 column-label "Vencer!5 a 17 anos"
             format ">>>,>>>,>>9.99"  (total)
             fn-risco.ven-9999 column-label "Vencer!+ 17 anos"
             format ">>>,>>>,>>9.99"  (total)
...
procedure relatorio-faixa-analitico:
    ...
    for each GClasOPC where
                   ...
                   GClasOPC.riscon  = pdvd2017.faixa_risco and
                   GClasOPC.situacao = ""
                   no-lock:
        ...
        then vdtven = titulo.titdtven.
            ...
            find first sc2017 where
                   sc2017.clifor = GClasOPC.clifor and
                   sc2017.titnum = GClasOPC.titnum and
                   (sc2017.titsit = "LIB" or
                   (sc2017.titsit = "PAG" and
                    sc2017.titdtpag > vdatref))
                   no-lock no-error.
            if avail sc2017
            then vdtven = sc2017.titdtven.
        end.
        vprovisao = (GClasOPC.vencido + GClasOPC.vencer) *                             (pdvd2017.pctprovisao / 100).
    ...
    for each GClasOPC where
                   ...
                   /*GClasOPC.catcod  => 0 and*/
                   GClasOPC.modcod  = "CRE" and
                   GClasOPC.riscli  = pdvd2017.faixa_risco and
                   GClasOPC.situacao = ""
                   no-lock:
        find clien where clien.clicod = GClasOPC.clifor no-lock no-error.
        if avail clien
    ...
    **************/
    ...
    for each visdev17 where visdev17.data_visao = vdatref  and
                            visdev17.tipo_visao = vtpvisao and
                            visdev17.risco_cliente = p-risco and
                            visdev17.situacao = ""
                            no-lock:

        find clien where clien.clicod = visdev17.clifor no-lock no-error.
        if avail clien
        then assign
                vclinom = clien.clinom
                vciccgc = clien.ciccgc.
        ...
        for each titulo where
                 titulo.empcod = visdev17.empcod and
                 titulo.titnat = visdev17.titnat and
                 titulo.modcod = visdev17.modcod and
                 titulo.titdtemi = visdev17.titdtemi and
                 titulo.etbcod = visdev17.etbcod and
                 titulo.clifor = visdev17.clifor and
                 titulo.titnum = visdev17.titnum and
                 (titulo.titsit = "LIB" or
                 (titulo.titsit = "PAG" and
                  titulo.titdtpag > vdatref)) 
                 no-lock: 
            if visdev17.qtdatr > 0 /*220*/
            then vdtven = titulo.titdtven - visdev17.qtdat.
        ...
        /****
        for each titadd17 where
                 titadd17.empcod = visdev17.empcod and
                 titadd17.titnat = visdev17.titnat and
                 titadd17.modcod = visdev17.modcod and
                 titadd17.titdtemi = visdev17.titdtemi and
                 titadd17.etbcod = visdev17.etbcod and
                 titadd17.clifor = visdev17.clifor and
                 titadd17.titnum = visdev17.titnum and
                 (titadd17.titsit = "LIB" or
                 (titadd17.titsit = "PAG" and
                  titadd17.titdtpag > vdatref)) 
                 no-lock: 
            if visdev17.qtdatr > 0 /*220*/
            then vdtven = titadd17.titdtven - visdev17.qtdat.
            else vdtven = titadd17.titdtven.
            vtitnum = titadd17.titnum.
            vtitvlcob = titadd17.titvlcob.
            vdatraso = vdatref - vdtven.
            disp vclinom 
                 vciccgc 
                 vtitnum 
            ...
            down with frame fd2.
            vtotal = vtotal + titadd17.titvlcob.
        end.
        ***/
    end.    
    ...
    *********************/
    ...
    /*
    varq = "/admcom/Contabilidade/clientes2017/saldo-clientes-"
                    + string(vdatref,"99999999") + "-risco-"
                                    + p-risco + ".csv".
    */                                
    ...
    for each visdev17 where visdev17.data_visao = vdatref  and
                            visdev17.tipo_visao = vtpvisao and
                            visdev17.risco_cliente = p-risco and
                            visdev17.situacao <> "EXCECD"
                            no-lock:

        if visdev17.total_vencido = 0 and
           visdev17.total_vencer = 0
        then next.    
        /*find clien where clien.clicod = visdev17.clifor no-lock no-error.
        if avail clien
        then*/ assign
                vclinom = visdev17.nome
                vciccgc = visdev17.cpf.
        /*else assign
                vclinom = "NOME"
                vciccgc = "CPF".
        */
        vok = no.
        if visdev17.vencimento_arquivo = ?
        then do:
        for each titulo where
                 titulo.empcod = visdev17.empcod and
                 titulo.titnat = visdev17.titnat and
        ...
        then for each titadd17 where
                 ...
                 (titadd17.titsit = "PAG" and
                  titadd17.titdtpag > vdatref)) 
                 no-lock:
            if titadd17.titvlcob > 0  and
               titadd17.titdtven <> ?  and
               titadd17.titdtven < 01/01/2030 and
               titadd17.titdtven > 01/01/1990
            then do:       
                if visdev17.qtdatr > 0 /*220*/
                then vdtven = titadd17.titdtven - visdev17.qtdat.
                else vdtven = titadd17.titdtven.
                valchar = string(titadd17.titvlcob).
                valchar = replace(valchar,",","").
                valchar = replace(valchar,".",",").
                put unformatted 
                vclinom 
        ...
        ***/
            ...
            vdtven = visdev17.vencimento_arquivo.
            valchar = string(visdev17.total_vencido + 
                             visdev17.total_vencer).
                valchar = replace(valchar,",","").
                valchar = replace(valchar,".",",").
                put unformatted 
                vclinom 
                ...
                vtotal = vtotal + 
                            visdev17.total_vencido + visdev17.total_vencer.
