...
repeat:
    ...
    display tt-promo.etbcod column-label "Fil"  
            tt-promo.vencod column-label "Codigo"
            ...
            tt-promo.premiov column-label "Premio!Vendedor"
                when tt-promo.premiov > 0
            tt-promo.premiog column-label "Premio!Gerente"
                when tt-promo.premiog > 0
    ...
    repeat:
        ...
        display 
            ...
            tt-promo.nome 
            tt-promo.valor  
            tt-promo.premiov when tt-promo.premiov > 0
            tt-promo.premiog when tt-promo.premiog > 0
            with frame frame-a.
...
procedure relatorio:
    ...
    {mdadmcab.i &Saida     = "value(varquivo)"   
                ...
                &Tit-Rel   = """PREMIACAO VENDA CELULAR CLARO""" 
                &Width     = "100"
                &Form      = "frame f-cabcab"}
    disp with frame ff1.
