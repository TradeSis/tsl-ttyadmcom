        ...
        then do:
            ...
            then do:
                ...
                then do with frame f-vndseguro.
                    ...
                    disp vndseguro.certifi format "x(15)"
                         clien.clinom.
                end.
...
then do.
    if par-tipo = "pri" 
    then find first vndseguro where vndseguro.tpseguro = vtpseguro
    ...
    if par-tipo = "pri" 
    then find first vndseguro where vndseguro.etbcod = vetbcod
