...
form " " 
     metadesp.modgru  column-label "Grupo Mod"
     modgru.mognom no-label 
...
l1: repeat:
    ...
    {sklclstb.i  
        &color = with/cyan
        &file = metadesp  
        &cfield = metadesp.modgru
        &noncharacter = /* 
        &ofield = " modgru.mognom when avail modal
                    metadesp.metval
                    "  
        &aftfnd1 = " find modgru where 
                          modgru.modcod = metades.modgru and
        ...
        &naoexiste1 = "  
                    ...
                    create metadesp.
                    update metadesp.modgru
                            with frame f-linha.
                    find first bmetadesp where
                               bmetadesp.etbcod = setbcod and
                               bmetadesp.setcod = vsetcod and
                               bmetadesp.modgru = metadesp.modgru and
                               bmetadesp.modcod = """" and
                               bmetadesp.metano = vano and
                               bmetadesp.metmes = vmes
                               no-lock no-error.
                    ...
                    find modal where modal.modcod =
                        metadesp.modgru no-lock no-error.
                    if not avail modal
                    then do:
                        message color red/with
                    ...
                    find modgru where modgru.modcod = metadesp.modgru and
                                      modgru.mogsup = 0 no-lock no-error.
                    if not avail modgru
                    then do:
                        message color red/with
                        ""Modalidade nao agrupadora"" skip
                        ""Inclusao nao permitida   ""
                        view-as alert-box.
                        leave l1.
                    end. 
                    metadesp.modgru = caps(metadesp.modgru).
                    disp    metadesp.modgru
