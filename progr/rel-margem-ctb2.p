        ...
        do dt = vdti to vdtf:
            ...
            for each plani where plani.movtdc = 5             and
                ...
                for each movim where movim.etbcod = plani.etbcod and
                       ...
                       vtotal-mov = vtotal-mov + (movim.movpc * movim.movqtm).
                 ...
                 for each movim where movim.etbcod = plani.etbcod and
                    ...
                    then vcat = 31.
                        ...
                        find first wmovim where 
                               wmovim.etbcod = movim.etbcod and
                               wmovim.placod = movim.placod and
                               wmovim.movtdc = movim.movtdc and
                        ...
                        then do:
                            create wmovim.
                            assign
                                wmovim.etbcod = movim.etbcod
                                wmovim.placod = movim.placod
                                wmovim.movtdc = movim.movtdc
