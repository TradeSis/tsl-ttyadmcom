...
def buffer etb-desti for clien.
...
do:
    DO:
        ...
        find etb-desti where etb-desti.clicod = tt-plani.desti no-lock.
        find mun-desti where mun-desti.cidnom = etb-desti.cidade[1] and
                             mun-desti.ufecod = etb-desti.ufecod[1] no-lock.
        ...
        ***/
        ...
        then do:
            ...
            assign
                ...
                E01_Dest.xnome = etb-desti.clinom
                /*E01_Dest.ie =    vdestiie
                E01_Dest.isuf 
                E01_Dest.cnpj  = vdesticgc
                E01_Dest.cpf   = */
                E01_Dest.xlgr  = etb-desti.endereco[1]
                E01_Dest.nro   = string(etb-desti.numero[1])
                /*E01_Dest.xcpl  = entry(3,etb-desti.endereco,",")*/
                E01_Dest.xbairro = etb-desti.bairro[1] 
                ...
                /*E01_Dest.cpais 
                E01_Dest.xpais */
                E01_Dest.fone  = dec(etb-desti.fone)
                .
            if length(vdesticgc) > 11
            then assign
                E01_Dest.cnpj  = vdesticgc
                E01_Dest.ie =    vdestiie.
            else assign
        ...
        then do:
        find first y01_pag of A01_infnfe where
                    y01_pag.tpag = int(entry(1,tt-plani.notped,"="))
                    no-error.
        if not avail y01_pag
        then do:
            create y01_pag.
            y01_pag.chave = A01_infnfe.chave.
            y01_pag.tpag = int(entry(1,tt-plani.notped,"=")).        
        end.
        y01_pag.vpag = tt-plani.platot.
        end.
