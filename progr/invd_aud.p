...
then do:
        vtipo = no.
        input from /admcom/audit/param_est.
        repeat:
            import varq.
...
vetbi = vetbcod.
if opsys = "unix"
then varquivo = "/admcom/audit/mov_" + trim(string(vetbi,"999")) + "_" +
                string(day(vdti),"99") +  
...
else varquivo = "l:\audit\mov_" + trim(string(vetbi,"999")) + "_" + 
                string(day(vdti),"99") +   
                string(month(vdti),"99") +   
                string(year(vdti),"9999") + "_" +  
                string(day(vdtf),"99") +   
...
for each estab where    if vetbcod > 0
    ...
    */
    ...
    for each produ no-lock:
        /*
        disp produ.procod with frame f-disp.
        pause 0.
        */
        if not vtipo
        then
...
if opsys = "unix"
then varquivo = "/admcom/audit/inv_" + trim(string(vetbi,"999")) + "_" +
                string(day(vdti),"99") +  
                string(month(vdti),"99") +  
                string(year(vdti),"9999") + "_" + 
                string(day(vdtf),"99") +  
...
else varquivo = "l:\audit\inv_" + trim(string(vetbi,"999")) + "_" + 
                string(day(vdti),"99") +   
                string(month(vdti),"99") +   
                string(year(vdti),"9999") + "_" +  
                string(day(vdtf),"99") +   
