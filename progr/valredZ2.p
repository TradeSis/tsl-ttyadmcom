...
def input parameter vequip as int.
def input parameter vserie as char.
...
repeat:
    ...
    */
    ...
    display  vtot01  to 35 format ">>>>>,>>9.99"
             vtot02  to 44 format ">>,>>9.99"
             vtot03  to 53 format ">>,>>9.99" 
             vtot04  to 65 format ">>>>>,>>9.99"
