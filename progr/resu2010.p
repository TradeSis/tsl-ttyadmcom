...
def var v-valor like plani.platot format "-zzz,zzz,zz9.99".
                ...
                */
                ...
                then do:
                    ...
                    for each bf-movim where bf-movim.etbcod = plani.etbcod and
                        ...
                        then do:
                            if vcatcod <> 31
                            then if bf-produ.catcod <> vcatcod
                                 then vignora = yes.
                            if vcatcod = 31
                            then if bf-produ.catcod = vcatcod or
                    ...
                    then do:
                        ...
                        if plani.biss > (plani.platot - plani.vlserv)
                        then assign acre = plani.biss -
                                             (plani.platot - plani.vlserv).
                        else acre = plani.acfprod.
