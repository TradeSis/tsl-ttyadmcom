...
define temp-table tt-valores no-undo serialize-name 'fornecedor'
...
for each forne no-lock:
    ...
    create tt-valores.
    assign tt-valores.codigo    = forne.forcod
           tt-valores.descricao = fnremoveacento(forne.fornom)
    ...
    if i-cont = 3000 then do:
        ...
        RUN PostRequest (INPUT 'produtos/integracaoFornecedor', 
                         INPUT lo-arquivo).
