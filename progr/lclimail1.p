...
def var vcha-situ-aux as char init "Ambos".
...
update vdti at 2 label " Periodo de"
       vdtf label "    Ate"
       with frame f-dados.
...
then do on error undo:
    ...
    for each ttcli:
        assign
            bal_cli.total_cliente = bal_cli.total_cliente + ttcli.qtd-geral
            bal_cli.com_email = bal_cli.com_email + ttcli.qtd-emails
            bal_cli.inativos  = bal_cli.inativos + ttcli.inativos
            bal_cli.recuperados = bal_cli.recuperados + ttcli.recuperados
            bal_cli.ativos_compra = bal_cli.ativos_compra + ttcli.ativos-pla
            bal_cli.ativos_contrato = bal_cli.ativos_contrato + ttcli.ativos
            bal_cli.novo_compra = bal_cli.novo_compra + ttcli.novos
            bal_cli.novo_contrato = bal_cli.novo_contrato + ttcli.novos1
            .
    end.    
end.
