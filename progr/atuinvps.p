...
update vetbcod label "Filial" with side-label.
...
update varquivo1 at 1 format "x(60)"  label "Local do arquivo"
         with side-label.
         
varquivo = varquivo1 + "atuinvadm.txt".


output to ./log-arq.txt.
unix silent value(" ls " + varquivo1 + "INV-" + 
...
for each tt-arq.
    disp tt-arq.arquivo format "x(50)"   .
end.
