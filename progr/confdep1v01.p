...
repeat:
    ...
    *************/
    ...
    for each estab no-lock:
        ...
        /***/ 
        for each confdepb where confdepb.etbcod  = estab.etbcod and
                                confdepb.datmov  = vdata
                                no-lock.
            create tt-arq.
            assign
                tt-arq.datmov   = confdepb.datmov
                tt-arq.dephora   = confdepb.dephora
                tt-arq.valdep    = confdepb.valdep
                .
        end.
        /***/
        ...
        ***/
        ...
        repeat: 
            ...
            then do:   
                ...
                vdephora = substr(string(int(vdephora)),1,6).
    ...
    then.
        ...
        repeat:
            ...
            then do:
                ...
                if substr(vdephora,1,1) <> "0" or
                   substr(vdephora,1,1) <> "1" or
                   substr(vdephora,1,1) <> "2" or
                   substr(vdephora,1,1) <> "3" or
                   substr(vdephora,1,1) <> "4" or
                   substr(vdephora,1,1) <> "5" or
                   substr(vdephora,1,1) <> "6" or
                   substr(vdephora,1,1) <> "7" or
                   substr(vdephora,1,1) <> "8" or
