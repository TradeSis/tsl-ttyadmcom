        ...
        ***/
        ...
        do vdt = wdti to wdtf:
            ...
            for each wmodal:
                ...
                for each fin.titluc where fin.titluc.empcod = wempre.empcod and
                    ...
                    wfor.wrec  = wfor.wrec  + fin.titluc.titvlcob
                    wdoc.wrec  = wdoc.wrec  + fin.titluc.titvlcob.
        ...
        for each wgru no-lock,
            ...
            display wgru.wmodcod
                    ...
                    wgru.wdeb
                        format "->>>,>>>,>>>,>>9.99" column-label "Debito" 
                with frame f-pag down width 150.
