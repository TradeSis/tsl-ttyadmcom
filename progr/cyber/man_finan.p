...
for each lotcrecontrato of lotcre no-lock.
    ...
    find contnf where contnf.etbcod  = cyber_contrato.etbcod and
    ...
    run cyber/dados_contrato.p (input recid(cyber_contrato)).
    ...
    put unformatted
        ...
        cyber_contrato.etbcod                format "9999"    /*             */
        formatadata(cyber_contrato.dtinicial) format "x(8)"    /*             */
        vcobranca                            format "99"      /*             */
        vcxacod                    format "99"    /*             */
