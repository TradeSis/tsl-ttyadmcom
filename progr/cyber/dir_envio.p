...
then  
    if esqascend  
    then  
        find first tab_ini where tab_ini.parametro = "CYBER_DIRETORIO_ARQUIVOS"
                                no-lock no-error.
    else  
        find last tab_ini  where tab_ini.parametro = "CYBER_DIRETORIO_ARQUIVOS"
                                no-lock no-error.
...
then  
    if esqascend  
    then  
        find next tab_ini  where tab_ini.parametro = "CYBER_DIRETORIO_ARQUIVOS"
                                no-lock no-error.
    else  
        find prev tab_ini  where tab_ini.parametro = "CYBER_DIRETORIO_ARQUIVOS"
                                no-lock no-error.
