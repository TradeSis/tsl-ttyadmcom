...
def new shared var vri as date format "99/99/9999" extent 9.
def new shared var vrf as date format "99/99/9999" extent 9.

def new shared var vfi as inte extent 9 format ">>>>>>>9".
def new shared var vff as inte extent 9 format ">>>>>>>9".

def new shared var vvi as dec format ">>>,>>9.99" extent 9.
def new shared var vvf as dec format ">>>,>>9.99" extent 9.
/*
