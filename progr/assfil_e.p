/*
*
*    assfil_e.p    -    Esqueleto de Programacao    com esqvazio
*
*/
...
def var esqcom1         as char format "x(12)" extent 5
    initial [" Alteracao "," Consulta "," Listagem "," Envia Filial ",""].
...
repeat:
    ...
    update vdti label "Data envio filial" format "99/99/9999"
        with frame fest.
    
    for each wfasstec: delete wfasstec. end.
    ...
    for each estab where if vetbcod = 0
        ...
        for each asstec where asstec.etbcod = estab.etbcod and
                              asstec.dtenvfil = vdti no-lock.
            if asstec.dtretass = ? 
            then next.              
            
            if can-find (first regtroca
                         where regtroca.oscod = asstec.oscod
                           and regtroca.nome_campo = "REGISTRO-TROCA"
                           and regtroca.valor_campo = "GARANTIA PLANO BI$")
            then next.               
            ...
            then do:
                ...
                then do with frame f-consulta side-label.
                    ...
                    disp asstec.pladat colon 10 label "Data NF"
                     ...
                     asstec.dtentdep at 1 label "Dt.Entrada Deposito"
                     asstec.dtenvass label "Dt.Envio Assistencia"
                     asstec.dtretass at 1 label "Dt.Retirada Assistencia"
                     asstec.dtenvfil  label "Dt.Envio para Filial" 
                ...
                then do with frame f-Lista:
                    ...
                    then do:
                        ...
                        varquivo = "/admcom/relat/assfil." + string(time).
 
                    end.    
                    else varquivo = "/admcom/relat/assfil." + string(time).
                ...
                if esqcom1[esqpos1] = " Envia Filial "
                then do:
