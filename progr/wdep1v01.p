    ...
    repeat with frame frame-a:
        ...
        then do on error undo, retry on endkey undo, leave.
            ...
            then do:
                ...
                run mandep01v01.p ( tt-dep.etbcod, tt-dep.pladat ).
        ...
        ******/
        ...
        then do:
            prompt-for tt-dep.etbcod label "Filial"
                with frame f-pro 1 down centered row 10
                side-label overlay.
            find first tt-dep where
                      tt-dep.etbcod = input frame f-pro tt-dep.etbcod
                      no-error.
            if avail tt-dep
            then recatu1 = recid(tt-dep).
            leave.
