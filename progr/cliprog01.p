...
def temp-table tt-tipo
    ...
    field vdesc as char format "x(34)"
...
then*/ do:
    ...
    assign
        tt-tipo.seq = 1
        tt-tipo.vdesc = "01-RELATORIO"
        .
    create tt-tipo.
    assign
        tt-tipo.seq = 2
        tt-tipo.vdesc = "02-EXPORTA CTB"
        . 
    create tt-tipo.
    assign
        tt-tipo.seq = 3
        tt-tipo.vdesc = "03-RELATORIO DE TOTAIS"
        .
    create tt-tipo.
    assign
       tt-tipo.seq = 4
       tt-tipo.vdesc = "04-EXPORTA DIARIO LAYOUT SISPRO".
    ...
    assign
       tt-tipo.seq = 6
       tt-tipo.vdesc = "06-RELATORIOS CTB".

    create tt-tipo.
    assign
       tt-tipo.seq = 7
       tt-tipo.vdesc = "07-RELATORIO TOTAIS MOVIMENTO".
...
l1: repeat:        
    ...
    {sklcls.i
     ...
     else if tt-tipo.seq = 2
     then  run cliprog77.p. /*EXPORTA CTB*/
     else if tt-tipo.seq = 3
     then run cliprog1514.p /*cliprog0514.p*/. /*RELATORIO VENDA E RECEBIMENTO*/
     else if tt-tipo.seq = 4
     then run expdauxclisispro.p.
     else if tt-tipo.seq = 5
     then run exp_diaux_clin_dsp.p /*expdauxcliaudit.p*/.
     else if tt-tipo.seq = 6
     then run cliprog78.p.
     else if tt-tipo.seq = 7
     then run cliprog1514-v001-2018.p.
