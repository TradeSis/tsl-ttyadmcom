...
for each estab.
    ...
    */
    ...
    /* Pagamentos */
    for each d.titulo 
        where d.titulo.empcod  = 19                 
          and d.titulo.titnat  = no                 
          and d.titulo.modcod  = "CRE"     
          and d.titulo.titsit  = "PAG" 
          and d.titulo.titdtpag >= today - 2 
          and d.titulo.titdtpag <= today 
          and d.titulo.etbcod  = estab.etbcod
              no-lock.
        find clilig where clilig.clicod = d.titulo.clifor no-lock no-error.
        if not avail clilig
        then next.
        else do:
            ...
            delete clilig.
            run cria-clilig (d.titulo.clifor).

            /*
            hide message no-pause.
            message "PAG" estab.etbcod d.titulo.clifor d.titulo.titdtpag.
            */
    ...
    for each d.titulo where d.titulo.empcod  = 19                 
                      ...
                      and d.titulo.etbcod  = estab.etbcod
                      and d.titulo.titdtven >= today - 2
                      and d.titulo.titdtven <= today
                no-lock.
          find clilig where clilig.clicod = d.titulo.clifor no-lock no-error.
          if avail clilig
          then next.
            ...
            /*
            hide message no-pause.
            message "VEN" estab.etbcod d.titulo.clifor d.titulo.titdtven.
            */
          end.  
    end.                    
    ...
    for each d.titulo where d.titulo.empcod  = 19                 
                      ...
                      and d.titulo.titsit  = "LIB" 
                      and d.titulo.etbcod  = estab.etbcod
                      and d.titulo.titdtemi >= today - 2
                      and d.titulo.titdtemi <= today
                      and d.titulo.titpar > 30
                no-lock.
            /* Se tem outra vencida, atualiza clilig, senao deleta */          
            for each clilig where clilig.clicod = d.titulo.clifor exclusive.
                delete clilig.
            end.                
            /* Se nao tem clilig, criar... */
            run cria-clilig (d.titulo.clifor).
            /*
            hide message no-pause.
            message "NOV" estab.etbcod d.titulo.clifor d.titulo.titdtemi.      
            */
        end.    
end.    
