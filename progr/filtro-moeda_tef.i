    ...
    */  
    ...
    then do. 
        cmoeda = "Geral".
        for each moeda where moeda.moenom begins "TEF" no-lock.
            create wfmoeda.
            assign wfmoeda.moecod = moeda.moecod.
        end.
        cmoeda = "".
        vmoeda = no.
    end.
      ...
      repeat with frame fmoeda title "Selecao de Moedas "
        ...
        find first moeda where moeda.moecod = wfmoeda.moecod 
                           and moeda.moenom begins "TEF"
                            no-lock no-error.
        if not avail moeda
        then do:
