...
repeat with column 50 side-labels 1 down width 31 row 4 frame f1:
    ...
    repeat:
        clear frame ff.
        clear frame fc.
        do with column 1 side-labels 1 down width 48 row 4 frame ff:
             disp "" @ wclifor.
        ...
        for each wmodal:
            if wmodal.modcod = "CHP"
            then delete wmodal.
        end.
        update vevecod with frame f-eve side-label centered.
        find event where event.evecod = vevecod no-lock.
        display event.evenom no-label with frame f-eve.
        wtot = 0.
        ...
        for each wpag break by wpag.wmodcod
            ...
            display wpag.wcod
                    ...
                    vtot  when last-of(wpag.wmodcod)
                                         column-label "Acum.Geral"
