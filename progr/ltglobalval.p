/* Programa de Validacao Assessoria Global */
{admcab.i}
...
def var vct      as int.
    ...
    for each lotcreag of lotcre exclusive.
        ...
        */
        ...
        then lotcreag.ltvalida = lotcreag.ltvalida + "TELEFONE ".
        ...
        */
        ...
        /* Verifica se o titulo não está em outra assessoria */
        for each lotcretit of lotcreag.
            ...
            if titulo.cobcod = 11 /*ACCESS -  Titulo em outras assessoria*/
            then lotcreag.ltvalida = lotcreag.ltvalida + " ACCESS ".
