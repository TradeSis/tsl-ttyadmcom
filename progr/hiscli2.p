...
#2 04.12.18 - TP 28232984
#3 15.02.19 - Helio.Neto Criado Nova Versao
*/
{admcab.i}
run cob/hiscli2compor.p (input ?, input ""). /*H24082021*/
...
for each titulo where titulo.empcod = 19
    ...
    then do:
        ...
        /* #1 else parcela-paga = parcela-paga + 1. */
    end.

    /* #1 */
    if titulo.titsit = "PAG"
    then parcela-paga = parcela-paga + 1.
