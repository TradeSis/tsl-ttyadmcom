...
put "Filial" setbcod " - " string(contrato.dtinicial,"99/99/99") skip. 
...
put unformatted "Eldorado do Sul, "  trim(string(day(contrato.dtinicial)))
 " de " vmescomp[month(contrato.dtinicial)] 
    " de " string(year(contrato.dtinicial)) "."
    skip(2).
