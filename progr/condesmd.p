...
def var vvalorDescontoDisponivel as dec format "->>>>>>9" column-label "Desc!Disp.!Loja". /* helio 080224 - alterado nomenclatura */
def var vvalorDescontoDisponivelRegional as dec format "->>>>>>9" column-label "Desc!Disp.!Regional". /* helio 080224 - novo campo */
...
then do:
    ...
    for each ttmargemdesconto.
     ...
     field periodoVendaFinal        as char. /*":"2020-01-30" */
        ...
        vvalorDescontoDisponivelRegional = dec(valorDescontoDisponivelRegional).
    ...
    message "Informacoes do SAP". 
        ...
        disp 
            ...
            */
            ...
            vvalorDescontoDisponivelRegional
