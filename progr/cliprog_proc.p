...
then do:
    ...
    assign
        tt-tipo.seq = 3
        tt-tipo.vdesc = "03-TOTAIS DA BASE GERADA"
        .
    
    create tt-tipo.
    assign
        tt-tipo.seq = 4
        tt-tipo.vdesc = "04-GERA TABELA DE VALORES"
        .

    create tt-tipo.
    assign
        tt-tipo.seq = 5
        tt-tipo.vdesc = "05-CONCILIACAO VALORES"
        .

    create tt-tipo.
    assign
        tt-tipo.seq = 6
        tt-tipo.vdesc = "06-TRANSFERE RECEBIMENTO"
        .

    create tt-tipo.
    assign
        tt-tipo.seq = 7
        tt-tipo.vdesc = "07-PAGA CONTRATODD"
        .

    create tt-tipo.
    assign
        tt-tipo.seq = 8
        tt-tipo.vdesc = "08-AVISTA GERA CONTRATODD"
        .

    create tt-tipo.
    assign
        tt-tipo.seq = 9
        tt-tipo.vdesc = "09-TABDAC GERA TITSALCTB"
        .

    create tt-tipo.
    assign
        tt-tipo.seq = 10
        tt-tipo.vdesc = "10-IMPORTA E/C FINANCEIRA"
        .

    create tt-tipo.
    assign
        tt-tipo.seq = 11
        tt-tipo.vdesc = "11-GERA MOVIMENTO E/C FINANCEIRA"
        .

    create tt-tipo.
    assign
        tt-tipo.seq = 12
        tt-tipo.vdesc = "12-GERA BASE DE SALDO"
        .
    create tt-tipo.
    assign
        tt-tipo.seq = 13
        tt-tipo.vdesc = "13-AJUSTA BASE DE SALDO"
        .
...
l1: repeat:        
    ...
    {sklcls.i
     ...
     then do:
        ...
        run cliprog9514.p /*cliprog9513.p*/ . /*GERA BASE DE DADOS*/
            
     end.
     if tt-tipo.seq = 3
     then do:
        run cliprog1514.p /*cliprog0514.p*/. /*TOTAIS DA BASE GERADA*/
     end.
     if tt-tipo.seq = 4
     then do:
        message color red/with
        ...
        view-as alert-box.
        /*
        run cliprog1515.p /*cliprog0515.p*/. /*GERA TABELA DE VALORES*/
        */
     end.
     if tt-tipo.seq = 5 /*CONCILIACAO*/
     then do:
        run cliprog0517.p.
     end.
     if tt-tipo.seq = 6
...
procedure cliprog0516:
    ...
    then assign
            ...
            vrec-banri       = ctcartcl.rec-banri
            vrec-master      = ctcartcl.rec-master
            .
    ...
    assign
        ...
        ctcartcl.rec-banri = vrec-banri
        ctcartcl.rec-master = vrec-master
        .
