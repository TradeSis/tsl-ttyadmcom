...
repeat:
    ...
    then do:
        ...
        "Arquivo com problema ou com mais de uma coluna." skip
    ...
    for each titulo where titulo.empcod = 19 and
        ...
        then do on error undo:
            ...
            assign envfinan.empcod = titulo.empcod
                ...
                envfinan.c-2 = program-name(1)
                .
    
        end.
        else if envfinan.envsit <> "INC" and
                envfinan.envsit <> "PAG"
        then next.
...
procedure p-registro-10.
  ...
  v-data-vecto = vdata-arq /*10/25/2010*/.
