...
form vcre as log format  "Geral/Facil" label "Cliente"  at 4
     ...
     vcatcod like categoria.catcod    label "Categoria"       at 2
     categoria.catnom no-label
     vclacod like clase.clacod       label "Classe"          at 5
     clase.clanom no-label   
     vprocod like produto.procod  label "Produto"         at 4
            ...
            for each estab where
                ...
                then do:
                    ...
                    for each movim where movim.etbcod = plani.etbcod and
                                     ...
                                     no-lock:
                        find produ where produ.procod = movim.procod no-lock:                           if vcatcod > 0 and
