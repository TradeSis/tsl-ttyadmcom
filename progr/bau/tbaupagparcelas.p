...
def var vvlcobrado   as dec.
    form  
        baupagparcelas.codigoBarras
        baupagparcelas.adepar 
        baupagparcelas.dtvenc
        baupagparcelas.valor
        baupagparcelas.dtpgto
...
repeat:
    ...
    else find baupagparcelas where recid(baupagparcelas) = recatu1 no-lock.
    if not available baupagparcelas
    then do.
    ...
    repeat with frame frame-a:
        ...
        find baupagparcelas where recid(baupagparcelas) = recatu1 no-lock.
...
/*        vhelp = "".
        ...
        choose field baupagparcelas.adepar
                      help ""
...
def input parameter par-tipo as char.
    ...
    if par-tipo = "pri" 
    then do:
        find first baupagparcelas of baupagamento
            no-lock no-error.
    end.    
    if par-tipo = "seg" or par-tipo = "down" 
    then do:
        find next baupagparcelas of baupagamento
            no-lock no-error.
    end.    
    if par-tipo = "up" 
    then do:
        find prev baupagparcelas of baupagamento
            no-lock no-error.
    end.    
