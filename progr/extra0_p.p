...
repeat:
    ...
    vetbcod = setbcod.
    disp vetbcod label " Filial" with frame f-pro.
    ...
    */
    ...
    MESSAGE 
    "Atencao :   Este produto pode ter Movimentacoes de Devolução de Venda," skip 
    "que irao aparecer apos o encerramento dos Caixas e emissao de N.Fiscais" skip     "Tais Operacoes devem ser consideradas no Saldo Final do Produto!"    
           view-as alert-box.                                                  
    ...
    do vdata = vdata1  /**date(month(vdata1),1,year(vdata1))**/ to vdata2: 
        for each movim where movim.procod = produ.procod and
                             ...
                             movim.datexp = vdata no-lock by movim.datexp
                                                          by movim.movtdc desc:
            if movim.movtdc = 22 or movim.movtdc = 30
            or movim.movtdc = 50 or movim.movtdc = 45
            or movim.movtdc = 51
            then next.
