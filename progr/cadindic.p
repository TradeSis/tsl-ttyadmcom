...
form
    indic.indcod  format ">>9"
    indic.inddes
    with frame f-linha
        centered
        down   color withe/red
        .
           ...
           "if keyfunction(lastkey) = ""RETURN""
            ...
            then do :
                ...
                MESSAGE color red/withe
                    "" Confirma Exclusao de Indicador ""
                    indic.inddes view-as alert-box
                    buttons yes-no title "" Exclusao "" set sresp.
                IF NOT sresp  THEN next keys-loop.
                delete indic. a-seeid = -1.
                next keys-loop.
            end. "
        &Otherkeys = " cadindic.ok "
        &naoexiste = " cadindic.in "
        &abrelinha = " cadindic.in "
        &Form = " frame f-linha "
    }.
    if keyfunction(lastkey) = "END-ERROR"
    then leave.
