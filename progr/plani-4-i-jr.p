                ...
                for each tt-movim no-lock:
                    ...
                    then assign
                            tt-metacomis.v7  = tt-metacomis.v7 +
                                (if tt-movim.movtot <> ?
                                 then (tt-movim.movtot * tt-movim.movqtm)
                    ...
                    then assign
                            ...
                            .
                    else if (produ.procod = 559910 or
...
"      MOVEIS".
    ...
    then do:
        ...
        for each tt-lj no-lock:
            ...
            for each tt-metacomis where tt-metacomis.moveis > 0:
                if  tt-metacomis.moveis > 0 and vende-31 > 0 and
                    tt-metacomis.moveis >= tt-metacomis.moda 
                then assign
                    tt-metacomis.mvenda = vmeta-31 / vende-31
                ...
                then do:
                    ...
                    tt-metacomis.g6 = tt-metacomis.g6 - 
                                (tt-metacomis.d6 + tt-metacomis.g6).
                    if tt-metacomis.g6 < 0 then tt-metacomis.g6 = 0.
                    ...
                    disp tt-metacomis.etbcod column-label "Fil"
                        ...
                        tt-metacomis.g3 + tt-metacomis.g4
                                    column-label "G3 + G4"
                        tt-metacomis.g5 column-label "G5"
                        with frame f-lj down width 160.
    ...
    then do:
        ...
        for each tt-lj no-lock:
            ...
            for each tt-metacomis: /*where tt-metacomis.moveis > 0 or
                                        tt-metacomis.moda > 0:*/
                ...
                if avail func
                then tt-metacomis.folha = func.usercod.  
                if tt-metacomis.folha <> "" and  tt-metacomis.rvenda > 0
                    /*(g1 > 0 or g2 > 0 or g3 > 0 or g4 > 0 or g5 > 0 or g6 > 0
                    or g7 > 0 or g8 > 0 or g9 > 0)*/
                then do:
                    tt-metacomis.g1 = tt-metacomis.g1 - 
                                (tt-metacomis.d1 + tt-metacomis.b1).
                    if tt-metacomis.g1 < 0 then tt-metacomis.g1 = 0.
                    ...
                    ***/
                    ...
                    disp    tt-metacomis.etbcod column-label "Fil"
                            ...
                            tt-metacomis.pronom  column-label "Desc. Produto" 
                             format "x(20)" 
                            /*tt-metacomis.rvenda(total) format ">>>,>>9.99"
                            column-label "Real Venda" */
