...
form liped.pedtdc  column-label "T" 
     ...
     liped.wmsgaiola column-label "Gaiola" format "x(11)"
...
procedure emissao-NFe:
    ...
    for each liped where liped.pedtdc = 5 and
                         ...
                         liped.lipsit = "A" and
                         liped.lipsep > 0 and
                         liped.protip = (if setbcod = 996 or setbcod = 995
                                         then "C" else "M")
                   no-lock.
        create tt-liped.
        ...
        ASSIGN tt-movim.movtdc = tt-plani.movtdc
               ...
               tt-plani.NotPed = "Gaiola=" + liped.wmsgaiola
