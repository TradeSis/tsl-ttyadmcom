/*
*
*    pdvdoc.p    -    Esqueleto de Programacao    com esqvazio
*
*/
{admcab.i}
...
repeat:
    ...
    then do.
        message "Sem pdvdoc" view-as alert-box.
        leave.
    end.
    else esqvazio = no.
    ...
    repeat with frame frame-a:
        ...
        then do:
            ...
            then do:
                ...
                if not avail pdvdoc
                then next.
                color display white/red pdvdoc.sequencia with frame frame-a.
                if frame-line(frame-a) = frame-down(frame-a)
        ...
        then do:
            ...
            then do:
                ...
                then do with frame f-pdvdoc.
                    disp pdvdoc.
                    disp pdvdoc.cmocod format ">>>>>>".
                end.
            end.
            else do:
...
procedure frame-a.
    find cmon of pdvdoc no-lock no-error.
    display
        pdvdoc.etbcod column-label "Etb"
        pdvdoc.datamov
