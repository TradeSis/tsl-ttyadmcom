/*#1 helio.neto - 21.08.2019 - ajuste para pregar o custo da tabela abascusto */
{admcab.i}
...
help "[F4] Encerra  [E] Exclui  [ENTER] Inclui Novo [P] Procura"
        ...
        then do:
            ...
            /* #1 */
            find abascusto where abascusto.procod = produ.procod
                no-lock no-error.
            if avail abascusto
            then do:
                vlippre = abascusto.custocompra.
                
                vlippre = if abascusto.ipiperccompra <> 0 and
                             abascusto.ipiperccompra <> ?
                          then vlippre + (abascusto.custocompra * ipiperccompra / 100)
                          else vlippre.  
