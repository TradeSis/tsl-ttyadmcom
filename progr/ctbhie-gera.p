...
def var vmes like hiest.hiemes format "99".
def var vano like hiest.hieano format "9999".
...
repeat:
    ...
    for each estab where estab.etbcod >= vetbi and
                         estab.etbcod <= vetbf
                         no-lock:
        find first ctbhie where ctbhie.etbcod = estab.etbcod and
    ...
    message color red/with
    "Base de saldo gerada conforme parametros informados."
    view-as alert-box.
    leave.
