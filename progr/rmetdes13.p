...
for each wgru:
    find first wacu where
               ...
               wacu.wmod = wgru.wgru /*wmod*/ no-error.
    if not avail wacu
    then do:
        create wacu.
        wacu.wset = wgru.wset.
        wacu.wmod = wgru.wgru /*wmod*/ .
    end.
    wacu.wpag = wacu.wpag + wgru.wpag.
    wacu.wrec = wacu.wrec + wgru.wrec. 
    wacu.wdeb = wacu.wdeb + wgru.wdeb.
    wacu.wmet = wacu.wmet + wgru.wmet.   
    find first wsetor where wsetor.wsetcod = wgru.wset
                        and wsetor.wgru    = wgru.wgru no-error.
    if not avail wsetor
    then do:
        create wsetor.
        wsetor.wsetcod = wgru.wset.
        wsetor.wgru    = wgru.wgru.
    end.
end.    
