...
varquivo = "/var/www/drebes/intranet/bis/planobis31.txt".
...
vqtdven = 0.
vtotalven = 0.
varquivo = "/var/www/drebes/intranet/bis/planobis41.txt".
output to value(varquivo).
...
procedure cal-movim:
    ...
    valtotal = 0.
            for each com.movim where 
                ...
                if plani.biss = ?
                then vbiss = 0.
                else vbiss = plani.biss.
                
                if (plani.platot - plani.vlserv - plani.descprod) < vbiss
                then
                    val_fin =  ((((movim.movpc * movim.movqtm) 
                        - val_dev - val_des) /
                            (plani.platot - plani.vlserv - plani.descprod))
                            * vbiss) - ((movim.movpc * movim.movqtm) - 
                            val_dev - val_des).
            ...
            then do: 
               ...
               if vbiss > (com.plani.platot - com.plani.vlserv)  
               then val_acr  = vbiss  - 
               ...
               assign /*tt-ven.valor   = tt-ven.valor + valtotal
                        */
