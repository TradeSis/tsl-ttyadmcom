...
repeat:
    ...
    display vok no-label 
            ...
            salexporta.saldo  column-label "Prazo!Loja"
                                    format ">>,>>9.99"
    ...
    repeat:
        ...
        display vok
                ...
                salexporta.salimp 
                tt-saldo.pre 
                difpre when avail tt-saldo with frame frame-a.
    end.
        ...
        hide frame frame-a no-pause.
          ...
          then do:
            ...
            then do:
                ...
                varquivo = "..\relat\transmissao." + string (vetbcod,">>9") 
                                         + string(day(today)).
            ...
            then do:
                ...
                find first tt-ip where tt-ip.etbcod = vetbcod 
                                no-error.
                
                message "Conectando...".
                connect fin -H value("filial" + string(vetbcod,"999" )) -S sdrebfin -N tcp -ld finloja 
                                            no-error.
