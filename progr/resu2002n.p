...
repeat:
    ...
    update vdti label "Periodo"
           "a"
           vdtf no-label with frame f-dat centered color blue/cyan row 7
                                    title " Periodo ".
    ...
    update vcarcod label "Caracteristica " at 5 
           with frame f-caract centered side-labels color blue/cyan row 12
           title " Caracteristica / Sub-Caracteristica" width 79.
    if vcarcod <> 0
    then do:
    ...
    else disp "Geral" @ caract.cardes no-label format "x(15)" 
            with frame f-caract .
    ...
    else  disp "Geral" @ subcaract.subdes no-label format "x(15)" 
                    with frame f-caract.
    ...
    repeat:
        ...
        update vetbcod at 1
          with frame f-etb centered side-label color blue/cyan row 16 width 75.
        if vetbcod <> 0
        then do:
