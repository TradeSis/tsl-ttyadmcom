...
def temp-table tt-pdvd2013 like pdvd2013.
...
form pdvd2013.Faixa_risco column-label "Faixa" format "x(5)"
     pdvd2013.descricao_faixa no-label format "x(12)"  
     pdvd2013.saldo_curva column-label "Curva"      format ">>>>>>>>9.99"
     pdvd2013.pctprovisao column-label "%"          format ">>>9.99"
     pdvd2013.provisao    column-label "Provisao"   format ">>>>>>>>9.99"
     pdvd2013.principal   column-label "Principal"  format ">>>>>>>>9.99"
     pdvd2013.renda       column-label "Renda"      format ">>>>>>>>9.99"
...
vcobcod = ?.
vcatcod = ?.
for each pdvd2013 where pdvd2013.data_visao = vdatref     and
                        pdvd2013.tipo_visao = vtpfaixa /*vtipo_visao*/ and
                        pdvd2013.modo_visao = vmodo_visao and
                        pdvd2013.modalidade = "CRE" and
                        pdvd2013.cobcod     = ? and
                        pdvd2013.categoria  = ? and
                        pdvd2013.etbcod = 0
                        no-lock:
    assign
        tsaldo_curva = tsaldo_curva + pdvd2013.saldo_curva
        tprovisao    = tprovisao + pdvd2013.provisao
        tprincipal   = tprincipal + pdvd2013.principal
        trenda       = trenda + pdvd2013.renda
        .                
end.                    
...
l1: repeat:
    ...
    {sklclstb.i  
        ...
        &file  = pdvd2013  
        &help  = " "
        &cfield = pdvd2013.faixa_risco
        &noncharacter = /* */  
        &ofield = " pdvd2013.descricao_faixa
                    pdvd2013.saldo_curva
                    pdvd2013.pctprovisao
                    pdvd2013.provisao
                    pdvd2013.principal
                    pdvd2013.renda
                    "  
        &aftfnd1 = " "
        &where  = " pdvd2013.data_visao = vdatref and
                    pdvd2013.tipo_visao = vtpfaixa  and
                    pdvd2013.modo_visao = vmodo_visao and 
                    pdvd2013.modalidade = ""CRE"" and
                    pdvd2013.cobcod = vcobcod and
                    pdvd2013.categoria = vcatcod and
                    pdvd2013.etbcod = 0 "
        &aftselect1 = " 
                        run aftselect.
...
procedure aftselect:
    ...
    THEN DO:
        sresp = no.
        message 
        "Confirma gerar relatorio analitico faixa" pdvd2013.faixa_risco 
        update sresp.
        if sresp
        then do: 
            /*if vtipo_visao = "CONTABIL"
            then run relatorio-faixa-analitico-outros(pdvd2013.faixa_risco).
            else*/ run relatorio-faixa-analitico(pdvd2013.faixa_risco).
        end.
    END.
...
procedure relatorio:
    ...
    def var vencer90 like pdvd2013.vencer_90 .
    def var vencer360 like pdvd2013.vencer_360.
    def var vencer1080 like pdvd2013.vencer_1080.
    def var vencer1800 like pdvd2013.vencer_1800 .
    def var vencer5400 like pdvd2013.vencer_5400  .
    def var vencer9999 like pdvd2013.vencer_9999   .
    ...
    for each pdvd2013 where 
             pdvd2013.data_visao = vdatref and
             pdvd2013.tipo_visao = "RECEITA" and
             pdvd2013.modo_visao = vmodo_visao and
             pdvd2013.modalidade = "CRE" and
             pdvd2013.cobcod     = vcobcod and
             pdvd2013.categoria  = vcatcod and
             pdvd2013.etbcod = 0 no-lock:
        
         /*
        find first tbcntgen where
                   tbcntgen.tipcon = 13 and
                   tbcntgen.campo1[1] = pdvd2013.faixa_risco 
                   no-lock no-error.
        if avail tbcntgen
        then pdvd2013.descricao_faixa = tbcntgen.numini + "-" +
                            tbcntgen.numfim.
        */
        /***
        if pdvd2013.faixa_risco < "H"
        then assign
            vencidos = pdvd2013.vencido
            vencer90 = pdvd2013.vencer_90
            vencer360 = pdvd2013.vencer_360
            vencer1080 = pdvd2013.vencer_1080
            vencer1800 = pdvd2013.vencer_1800
            vencer5400 = pdvd2013.vencer_5400 
            vencer9999 = pdvd2013.vencer_9999
            .
        else assign
            vencidos = pdvd2013.vencido +
                       pdvd2013.vencer_90 + pdvd2013.vencer_360 +
                       pdvd2013.vencer_1080 + pdvd2013.vencer_1800 +
                       pdvd2013.vencer_5400 + pdvd2013.vencer_9999
            vencer90 = 0
            vencer360 = 0
            vencer1080 = 0
            vencer1800 = 0
        ...
        disp pdvd2013.faixa_risco column-label "Faixa"
             pdvd2013.descricao_faixa no-label   format "x(12)"
             ...
             format ">>>,>>>,>>9.99"  (total)
             pdvd2013.saldo_curva  column-label "Saldo Curva"
             format ">>,>>>,>>>,>>9.99"  (total)
             pdvd2013.provisao  column-label "Provisao"
             format ">>>,>>>,>>9.99"  (total)
             pdvd2013.pctprovisao column-label "%"
             pdvd2013.principal(total) column-label "Principal"
             format ">>>,>>>,>>9.99"
             pdvd2013.renda(total) column-label "Renda"
             format ">>>,>>>,>>9.99"
        ...
        ****/
        ...
        disp pdvd2013.faixa_risco
             pdvd2013.descricao_faixa
             pdvd2013.saldo_curva(total)   format ">>>,>>>,>>9.99"
             pdvd2013.pctprovisao(total)   format ">>>,>>>,>>9.99"
             pdvd2013.provisao(total)      format ">>>,>>>,>>9.99"
             pdvd2013.principal(total)     format ">>>,>>>,>>9.99"
             pdvd2013.renda(total)         format ">>>,>>>,>>9.99"
             with frame f-disp1 down width 220.
        down with frame f-disp1.     
...
procedure relatorio-faixa-analitico:
    ...
    for each GClasOPC where
                   ...
                   GClasOPC.riscon  = pdvd2013.faixa_risco and
                   GClasOPC.situacao = ""
                   no-lock:
        ...
        vprovisao = (GClasOPC.vencido + GClasOPC.vencer) *                             (pdvd2013.pctprovisao / 100).
    ...
    for each GClasOPC where
                   ...
                   /*GClasOPC.catcod  => 0 and*/
                   GClasOPC.modcod  = "CRE" and
                   GClasOPC.riscli  = pdvd2013.faixa_risco and
                   GClasOPC.situacao = ""
                   no-lock:
        find clien where clien.clicod = GClasOPC.clifor no-lock no-error.
        if avail clien
    ...
    **************/
    ...
    put unformatted string(vdatref,"99/99/9999") 
                ...
                skip.
    form with frame fd2.            
    for each visdev13 where visdev13.data_visao = vdatref  and
                            visdev13.tipo_visao = vtpvisao and
                            visdev13.risco_cliente = p-risco and
                            visdev13.situacao = ""
                            no-lock:

        find clien where clien.clicod = visdev13.clifor no-lock no-error.
        if avail clien
        then assign
                vclinom = clien.clinom
                vciccgc = clien.ciccgc.
        ...
        for each titulo where
                 titulo.empcod = visdev13.empcod and
                 titulo.titnat = visdev13.titnat and
                 titulo.modcod = visdev13.modcod and
                 titulo.titdtemi = visdev13.titdtemi and
                 titulo.etbcod = visdev13.etbcod and
                 titulo.clifor = visdev13.clifor and
                 titulo.titnum = visdev13.titnum and
                 (titulo.titsit = "LIB" or
                 (titulo.titsit = "PAG" and
                  titulo.titdtpag > vdatref)) 
                 no-lock: 
    ...
    *********************/
    ...
    for each visdev13 where visdev13.data_visao = vdatref  and
                            visdev13.tipo_visao = vtpvisao and
                            visdev13.risco_cliente = p-risco and
                            visdev13.situacao <> "EXCECD"
                            no-lock:

        if visdev13.total_vencido = 0 and
           visdev13.total_vencer = 0
        then next.    
        /*find clien where clien.clicod = visdev13.clifor no-lock no-error.
        if avail clien
        then*/ assign
                vclinom = visdev13.nome
                vciccgc = visdev13.cpf.
        /*else assign
                vclinom = "NOME"
                vciccgc = "CPF".
        */
        vok = no.
        if visdev13.vencimento_arquivo = ?
        then do:
        for each titulo where
                 titulo.empcod = visdev13.empcod and
                 titulo.titnat = visdev13.titnat and
            ...
            then do:                                  
                if visdev13.qtdatr > 0 /*220*/
                then vdtven = titulo.titdtven - visdev13.qtdat.
        ...
        /****
        if vok = no
        then for each titadd13 where
                 titadd13.empcod = visdev13.empcod and
                 titadd13.titnat = visdev13.titnat and
                 titadd13.modcod = visdev13.modcod and
                 titadd13.titdtemi = visdev13.titdtemi and
                 titadd13.etbcod = visdev13.etbcod and
                 titadd13.clifor = visdev13.clifor and
                 titadd13.titnum = visdev13.titnum and
                 (titadd13.titsit = "LIB" or
                 (titadd13.titsit = "PAG" and
                  titadd13.titdtpag > vdatref)) 
                 no-lock:
            if titadd13.titvlcob > 0  and
               titadd13.titdtven <> ?  and
               titadd13.titdtven < 01/01/2030 and
               titadd13.titdtven > 01/01/1990
            then do:       
                if visdev13.qtdatr > 0 /*220*/
                then vdtven = titadd13.titdtven - visdev13.qtdat.
                else vdtven = titadd13.titdtven.
                valchar = string(titadd13.titvlcob).
                valchar = replace(valchar,",","").
                valchar = replace(valchar,".",",").
                put unformatted 
                vclinom 
                ...
                vtotal = vtotal + titadd13.titvlcob.
            end.
        end.
        *****/
            ...
            vdtven = visdev13.vencimento_arquivo.
            valchar = string(visdev13.total_vencido + 
                             visdev13.total_vencer).
                valchar = replace(valchar,",","").
                valchar = replace(valchar,".",",").
                put unformatted 
                vclinom 
                ...
                vtotal = vtotal + 
                            visdev13.total_vencido + visdev13.total_vencer.
