/*
*
*    pdvforma.p    -    Esqueleto de Programacao    com esqvazio
*
*/
{admcab.i}
...
find pdvmov where recid(pdvmov) = par-rec no-lock.
...
def buffer bpdvforma       for pdvforma.
...
repeat:
    ...
    then do.
        message "Sem pdvforma" view-as alert-box.
        leave.
    end.
    else esqvazio = no.
    ...
    repeat with frame frame-a:
        ...
        then do:
            ...
            status default "".
            run color-message.
            choose field pdvforma.sequencia help ""
            ...
            then do:
                ...
                if not avail pdvforma
                then next.
                color display white/red pdvforma.sequencia with frame frame-a.
                if frame-line(frame-a) = frame-down(frame-a)
        ...
        then do:
            ...
            then do:
                ...
                then do with frame f-pdvforma.
                    disp pdvforma.
                    disp pdvforma.cmocod format ">>>>>>".
                end.
            end.
            else do:
...
procedure frame-a.
    find cmon of pdvforma no-lock no-error.
    display
        pdvforma.etbcod column-label "Etb"
        pdvforma.datamov
