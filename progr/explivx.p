...
for each admprog where admprog.menpro begins vdata no-lock.
    ...
    os-command silent value("/usr/dlc/bin/quoter -c 1-6,7-10,11-18,19-27 
               /admcom/relat/liv > /admcom/relat/livro.txt").  
  /*
    dos silent copy l:\relat\livro.txt l:\export\cpd02.
    dos silent copy l:\relat\livro.txt l:\export\cpd06.
    dos silent copy l:\relat\livro.txt l:\export\cpd16.
    dos silent copy l:\relat\livro.txt l:\export\cpd20.
    dos silent copy l:\relat\livro.txt l:\export\cpd24.
   */ 
