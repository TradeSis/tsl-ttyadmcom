...
def {1} shared var vsetcod like setaut.setcod.
...
def {1} shared var vempcod         like titulo.empcod.
def {1} shared var vetbcod         like titulo.etbcod.
def {1} shared var vmodcod         like titulo.modcod initial "DUP".
def {1} shared var vtitnat         like titulo.titnat.
def var vcliforlab      as char format "x(12)".
def var vclifornom      as char format "x(30)".
def {1} shared var vclifor         like titulo.clifor.
