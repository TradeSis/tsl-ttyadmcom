    ...
    for each movim where movim.etbcod = plani.etbcod and
        ...
        **/
        ...
        then do transaction:
            ...
            find plaviv where plaviv.tipviv = movim.ocnum[8]
                          and plaviv.codviv = movim.ocnum[9]
                          and plaviv.procod = movim.procod no-lock no-error.
            if avail plaviv
            then vvenda = plaviv.pretab.
            
            create divpre.
            assign divpre.etbcod = plani.etbcod
                   divpre.placod = plani.placod
                   divpre.procod = produ.procod
                   divpre.preven = movim.movpc
            ...
            if movim.ocnum[5] <> 0
            then divpre.divjus = "DESC. SUPERVISOR".
