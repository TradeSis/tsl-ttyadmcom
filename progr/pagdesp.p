...
def var esqcom1         as char format "x(12)" extent  5 
    initial ["Autorizacao","Consulta","Listagem","Observacao","Pagamento"].
...
/*    update vtitsit label "Situacao" with frame ff1. */
    ...
    for each foraut where if vsetcod = 0
        ...
        for each titluc where titluc.clifor = foraut.forcod and
                             (titluc.etbcod >= 900 or 
                                 {conv_igual.i titluc.etbcod}) and
                              titluc.titsit = "lib" no-lock:
            create tt-titluc. 
...
repeat:
    ...
    then do:
        message "Nenhuma despesa a pagar".
        pause.
        leave bl-princ.
    end.
    ...
    display titluc.etbcod    column-label "Fl" format "99"
            ...
            titluc.titdtpag  column-label "Dt.Pag."
          ...
          */
          ...
          then do:
            ...
            then do:
                ...
                varquivo = "..\relat\titluc" + STRING(day(today)).
