...
def new shared var vmodcod         like titulo.modcod initial "DUP".
...
repeat:
    ...
    do on error undo:
        ...
        then do:
            ...
            message color red/with
                "MODALIDADE precisa estar associada a um GRUPO ." skip
    ...
    **/
    ...
    /* if vtitnat */
    /* then */ find forne where forne.forcod = vforcod.
    /* else find clien where clien.clicod = vforcod no-error. */
    ...
    vlp = no.
    find first suporte.foraut where suporte.foraut.forcod = forne.forcod no-lock no-error.
    if avail foraut and foraut.autlp
    then vlp = yes.
    /* */
    vtipo-documento = 0.
    run tipo-documento.
...
procedure tipo-documento:
    ...
    def var vsel-sit1 as char format "x(15)" extent 4
          init["Nota Fiscal","Recibo Completo","RPA","Recibo Premio"].
    ...
    format skip(1)
        ...
        */
        ...
        va = 1.
            ...
            pause 0.
            vtipo-documento = va.
/*    message vtipo-documento view-as alert-box. */
