    ...
    for each tipmov where tipmov.tipemite = no or
        ...
        for each plani where plani.movtdc = tipmov.movtdc and
            ...
            ***********************/
            ...
            find bfiscal where bfiscal.emite = plani.emite and
                              bfiscal.desti  = plani.desti and
            ...
            then do:
                create bfiscal.
                assign  bfiscal.emite  = plani.emite
                        bfiscal.desti  = plani.desti
...
repeat:
    ...
    then do:
        if vnumero-nota <> 0
        then
        assign varq = "/admcom/audit/entd_" + trim(string(vetb,"x(3)")) + "_" +
                         string(day(vdti),"99") +  
    ...
    else varq = "l:\audit\entd_" + trim(string(vetb,"x(3)")) + "_" +
                string(day(vdti),"99") + 
                string(month(vdti),"99") +  
                string(year(vdti),"9999") + "_" +  
                string(day(vdtf),"99") +  
        ...
        then assign
                ...
                base_subs = if movim.movbsubst > 0
                            then movim.movbsubst
                             ...
                             ((movim.movpc * movim.movqtm) / plani.protot).
                /***13/08/14 tot-bicmscapa = tot-bicmscapa - base_icms***/ .
    end.
    ...
    */
    ...
    put unformatted 
        ...
        then put
                 base_subs       at 2238 format "9999999999999.99"
                 valor_subs      at 2254 format "9999999999999.99"
                 vmovicms        at 2270 format "9999999999999.99"
                 .
        else put /*0 at 2190 format "9999999999999.99"
                 0 at 2206 format "9999999999999.99"
                 0 at 2222 format "9999999999999.99"  */
