...
def var varfuncod like func.UserCod.
...
repeat with column 50 side-labels 1 down width 31 row 4 frame f1:
            ...
            for each wmodal:
                ...
                for each fin.titulo where fin.titulo.empcod = wempre.empcod and
                    ...
                    assign 
                        ...
                        tt-exp.funcionario = fin.titulo.vencod
                        .
                ...
                then do:
                    for each banfin.titulo where 
                        ...
                        assign 
                            ...
                            tt-exp.funcionario = banfin.titulo.vencod
                            .
    ...
    "COD.GRUPO;GRUPO;COD.MODALIDADE;MODALIDADE;COD.FORNECEDOR;FORNECEDOR;" +
           "CODIGO DESPESA;VA LOR DESPESA;"  format "x(240)"
           SKIP.
        ...
        for each tt-exp:
            ...
            then vval = substr(string(v,"x(20)"),1,15 - length(trim(vval)))
             ...
             find first func where func.funcod = tt-exp.funcionario                                                and func.etbcod = tt-exp.etbcod no-error.
        
                                                                                        if not avail func                                  
         then varfuncod = " ". 
     else varfuncod = func.UserCod.
