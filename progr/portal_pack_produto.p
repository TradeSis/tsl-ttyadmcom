...
define temp-table tt-valores no-undo serialize-name 'packProduto'
    field codigo    as integer serialize-name 'codigoProduto'
    field descricao as integer serialize-name 'loteProduto'
...
for each packprod no-lock:
    create tt-valores.
    assign tt-valores.codigo    = packprod.procod
           tt-valores.descricao = packprod.paccod
...
RUN PostRequest (INPUT 'produtos/integracaoPackProduto', 
                 INPUT lo-arquivo).
