...
repeat:
    ...
    varq-csv = "/admcom/relat/ven_" + trim(string(vetb,"x(3)")) + "_" +
                string(day(vdti),"99") +  
                string(month(vdti),"99") +  
                string(year(vdti),"9999") + "_" + 
                string(day(vdtf),"99") +  
...
procedure p-gera-linha.
  ...
  then assign
    ...
    */
    ...
    /*if base-icms = .01 and round(icm-item,2) = .02
    then icm-item = 0.
      */
        put unformatted
...
/* 043-049 */  vcooini format "999999"
/* 050-051 */  (if movim.movtdc = 5 then "00" else "02")
...
/* 344     */   "3.1.01"
/* 372     */   "3.1.01"
/* 360     */   plani.placod format ">>>>>>>>>>>9"     at 360.
/* 372     */
...
procedure cal-icms:
    ...
    for each plani where plani.movtdc = 5  and
        ...
        for each movim where movim.etbcod = plani.etbcod and
            ...
            if movim.movpc = 0 or movim.movqtm = 0 then next.   
            ...
            then do:
                ...
                put ((movim.movpc * movim.movqtm) *
                    (movim.movalicms / 100)) format "9999999999999.99" skip.
                output close.
                 */
            end.
        end. 
