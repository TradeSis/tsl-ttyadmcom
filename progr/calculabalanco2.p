       ...
       find first plani where                         
        ...
        /*CLIENTES NOVOS PROSPECT */                                         
                ...
                clien.dtcad <=  date(month(today),1,year(today)) + 31 and       
                          (mesatualvista = 0 AND mesatualprazo = 0) then do:                           
...
put clien.clicod ";" clien.clinom ";" statuscliente format "x(30)" ";" skip.   
           ...
           if(                                                                                (comprouantigamente = 0)                                                      and(comprouanoanterior = 0)                                                        and(qtdtitulostodos = 0)                                                     and (mesatualvista = 0 and mesatualprazo = 0)                                    ) then do:                                                                  statuscliente = "PROSPECT".                  
put clien.clicod ";" clien.clinom ";" statuscliente format "x(30)" ";" skip. 
          next.                                                              
                                    end.                                               
      ...
      /* CLIENTES NOVOS COMPRA A PRAZO */
            ...
            if (comprouantigamente = 0 and comprouanoanterior = 0 and
                qtdtitulostodos = 0 and mesatualprazo = 1)
                then do:
    ...
    /*CLIENTES NOVOS COMPRA A VISTA */
                ...
                if  (comprouantigamente = 0 and comprouanoanterior = 0 and 
                 qtdtitulostodos = 0 and mesatualvista = 1)            
                  then do:
                    statuscliente = "NOVO COMPRA A VISTA".                      
...
qtdnotasaprazo = 0.
         ...
         find first plani where 
          plani.pladat >= today - 384 and                          
           plani.pladat <= date(month(today),1,year(today)) - 1 and 
         plani.movtdc = 5 and
         plani.crecod = 2 and
         plani.modcod = "CRE" and
         plani.Dest = clien.clicod
 ...
 /* CLIENTES ATIVOS COMPRA A VISTA */                                             
     qtdnotasavista = 0.                                                            
        ...
        plani.pladat <= date(month(today),1,year(today)) - 1 and    
                  ...
                  plani.movtdc = 5 and                                                             plani.crecod = 1 and                                                           plani.modcod = "VVI" and                                                        plani.Dest = clien.clicod                                                               no-lock no-error.                                               
