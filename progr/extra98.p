...
form datasai format "99/99/9999" column-label "Data Saida"
    ...
    sal-atu format "->>>>9" column-label "Saldo" 
                         with frame f-val 8 down overlay
...
repeat:
    ...
    update vetbcod label "Filial 1" with frame f-pro.
    find estab where estab.etbcod = vetbcod no-lock.
    disp estab.etbnom no-label format "x(20)" with frame f-pro.

    update vetb label "Filial 2"  with frame f-pro.
    find bestab where bestab.etbcod = vetb no-lock.
    disp bestab.etbnom no-label format "x(20)" with frame f-pro.
    

    
    update vprocod with frame f-pro centered width 80 color blue/cyan 
                            row 3 side-label.
