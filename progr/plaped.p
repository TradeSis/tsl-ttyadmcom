/* #1 21.02.19 helio.neto ajustes para div01 ficar igual ao plaped.p */  
...
repeat:
    ...
    display forne.fornom no-label format "x(23)" with frame f1 width 80.
    ...
    for each plaped where plaped.forcod = forne.forcod and
        ...
        display pedid.pednum label "PE"
            plani.datexp label "Exp" format "99/99/99"
            with frame f1.
        ...
        for each movim where movim.etbcod = plani.etbcod and
            ...
            /*#1wprodu.pent = movim.movpc - movim.movdes.*/
            /*#1*/    
