...
def var vdata as date format "99/99/9999".
    ...
    */
    ...
    for each estab where if vetbcod = 0
        ...
        assign val07  = val07   + mapcxa.t03
               val18  = val18   + mapcxa.t02
               val15  = val15   + mapcxa.t01
               val11  = val11   + mapcxa.vlsub
               val19  = val19   + (mapcxa.t02 * 0.705889)
               valcon = valcon  + (mapcxa.t01 + 
                                   mapcxa.t02 +
                                   mapcxa.t03 +
                                   mapcxa.vlsub)
               valicm = valicm  + 
                        ( ( (mapcxa.t02 * 0.705889) + 
                            (mapcxa.t01)) * 0.17 +
                             mapcxa.t03 * 0.07)
               val12  = val12  + (mapcxa.t02 - (mapcxa.t02 * 0.705889)).
        
        
        if last-of(mapcxa.etbcod)
        then do:
            
            display mapcxa.etbcod column-label "Fil"
