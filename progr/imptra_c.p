...
def var vmes as char format "x(15)".
...
update vmes label "Mes" with frame f1 side-label centered.


create wmovim.
assign wmovim.pronom = "TRANSF. CREDITO ICMS REF. MES " + 
                       string(vmes,"x(15)") + 
                       string(plani.platot,">>,>>>,>>9.99").
...
then vtot = truncate((vcont / 24),0) + 1.
    ...
    put unformatted
        ...
        "TRANSFERENCIA DE CREDITO ICMS" at 2
        "5.602"           at 59
  ...
  for each wmovim:
     put unformatted
        ...
        put unformatted skip(1)
            ""         at 20 
            plani.platot  format ">,>>>,>>9.99" at 45 
            ""         at 85 
            ""         at 115 
            ""         at 140  skip
            ""         at 20 
