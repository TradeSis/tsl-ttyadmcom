...
procedure cria-tt.         
    ...
    then do:
      ...
      /**
      output to /admcom/work/teste.txt.
      disp "entrando cliente" skip.
      disp agi.ag3.clfcod skip. 
      output close.
      **/
      for each tt-clien.
      delete tt-clien.
      ...
      for each tt-clien where tt-clien.clicod = agi.ag3.clfcod: 
            vcalclim = 0.
            vpardias = 0.
      ...
      output close.
      /**
      output to /admcom/work/teste1.txt.
      disp "entrando cliente" skip.
      output close.
      **/
      varquivo = "/admcom/connect/retorna3/filial".
             ...
             then do:
                ...
                find first adm.tbprice where
                           ...
                           adm.tbprice.data_venda =
                                date(substr(string(agi.ag3.aux-param1),4,10)) and
                           adm.tbprice.nota_venda =
                                int(substr(string(agi.ag3.aux-param1),14,9))
                           no-lock no-error.
                if avail adm.tbprice
                then do:
                    export adm.tbprice.
