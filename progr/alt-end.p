...
def var esqhel1         as char format "x(80)" extent 5
    initial [" ",
             " Alteracao de endereço do pedido ",
             "  Consulta de endereço do pedido ",
             "  ",
             "  "].
...
repeat:
    ...
    repeat with frame frame-a:
        ...
        then do:
            ...
            form pedecom.endereco    format "x(50)"      at  1   skip
                 pedecom.numero      format ">>>>>>>9"   at  1   skip                           pedecom.complemento format "x(30)"      at 09   skip
                 pedecom.cep                             at 17   skip
                 pedecom.bairro                          at 14   skip
                 pedecom.cidade                          at 14   skip
                 pedecom.uf                              at 14   skip
            ...
            then do:
                ...
                then do with frame f-pedecom on error undo.
                    ...
                    sparam = "pedecom," + string(pedecom.pednum).
                        
                    run psenauto.p (output sresp).
...
procedure frame-a.
display pedecom.pednum                          label "Pedido"
        pedecom.endereco     format "x(23)"     label "Endereco"
        pedecom.numero       format ">>>>9"     label "Num."
        pedecom.complemento  format "x(8)"     label "Compl."
        pedecom.cep                             label "CEP"
   /*   pedecom.bairro       format "x(10)"     label "Bairro" */
        pedecom.cidade       format "x(16)"      label "Cidade"
        pedecom.uf                              label "UF"
...
then  
    if esqascend  
    then  
        find first pedecom where true
                                                no-lock no-error.
    else  
        find last pedecom  where true
                                                 no-lock no-error.
...
then  
    if esqascend  
    then  
        find next pedecom  where true
                                                no-lock no-error.
    else  
        find prev pedecom   where true
                                                no-lock no-error.
