...
def var lEmail      as logi form "Sim/Nao"        init no        no-undo.
...
/*
for each tt-clase:
    disp tt-clase.clacod tt-clase.clanom.
...
*/
    ...
    if opsys = "UNIX"
    then do:
            assign varquivo = "/admcom/relat/inv" + STRING(day(vdata),"99") +
    ...
    then do:
        /*
        display   "Estabelecimento:" p-estab no-label skip
                          "Data:" p-data no-label
                                with frame f4 down width 50.
        */
        ...
        /*
            display   "Estabelecimento:" p-estab no-label 
                          "Data:" p-data no-label skip
                                with frame f4 down width 50.
        */
