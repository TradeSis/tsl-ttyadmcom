...
do on error undo, retry:
    ...
    find FIRST d-tabmix where d-tabmix.tipomix = "F" and
        ...
        then do:
            ...
            then do:
                message color red/with
                    ...
                    " nao possui informacao de produtos ou classes ou filial."
                    view-as alert-box.
                undo.
            end.
        end.
    ...
    do on error undo, retry:
        ...
        etbcod-destino = b-tabmix.etbcod.
        ...
        then do:
            message color red/with
                ...
                " ja possui informacao de filial.".
            undo.
        end.
...
sresp = no.
message "Confirma iniciar copia ? " update sresp. 
if sresp 
then.
else return.
...
if s-p = yes
then do:
    for each p-tabmix where p-tabmix.tipomix = "F" and
...
for each c-tabmix where
         c-tabmix.tipomix = "F" and
         c-tabmix.codmix  = padrao-origem and
         c-tabmix.promix > 0
         no-lock:
    if length(string(c-tabmix.promix)) < 9
    then next.
    ...
    find p-tabmix where p-tabmix.tipomix = c-tabmix.tipomix and
                        ...
                        p-tabmix.etbcod  = b-tabmix.etbcod and
...
for each tt-tabmix where tt-tabmix.promix > 0.
    ...
    tt-tabmix.etbcod = etbcod-destino.
