...
form
    vetbcod  label  "Lj"
    bbestab.etbnom no-label format "x(12)" 
    vmes no-label space(0) "/" space(0) vano no-label
    
    vdti     label "De" format "99/99/99"
    vdtf     label "A" format "99/99/99"
/*    vhora    label "H" */
    ...
    find first bbestab where bbestab.etbcod = plani.etbcod 
      ...
      */      
        ...
        repeat.
            ...
            ttvendedor.platot = ttvendedor.platot + (if tipmov.movtdev 
                                             then - (vplatot) 
                                             else vplatot).
            ttvendedor.acfprod = ttvendedor.acfprod + (if tipmov.movtdev 
                                             then - (vacfprod) 
                                             else vacfprod). 
