...
def var vobs     like plani.notobs.
    ...
    varq = "/admcom/audit/ent" + string(vetbcod,"99") + "_" +
           string(day(vdti),"99") + 
            ...
            for each fiscal where fiscal.movtdc = tipmov.movtdc and
                ...
                then do:
                    ...
                    for each movim where movim.etbcod = plani.etbcod and
                        ...
                        if plani.emite = 100725 and
                           per_desc > 0
                        then do:

                            valor_item = movim.movpc / (1 - per_desc).
                            vdes = (movim.movpc / (1 - per_desc)) * per_desc.
                        
                            protot_capa = plani.protot / (1 - per_desc).
                            
                            desc_capa   = ((plani.protot / (1 - per_desc))
                                          * per_desc).
                            
                            base_ipi = (valor_item * movim.movqtm).
                            vipi  = base_ipi  * (movim.movalipi / 100).


                           
                            base_icms = (fiscal.bicms / plani.protot) * 
                                        (valor_item * movim.movqtm).
                            val_contabil = (valor_item * movim.movqtm) 
                                           + vipi.
                            ...
                            voutras = val_contabil - base_icms - vipi 
                                      - visenta.
                            if voutras < 0
                            then voutras = 0.
