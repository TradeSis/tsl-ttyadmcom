        ...
        then do:
            ...
            then do:
                ...
                then do with frame f-credscore on error undo.
                    ...
                    create credscore.
                    credscore.desc-campo = "ESTABCLI".
                    do on error undo.
                    update
                         credscore.campo  label "Estab. Cliente" format "x(5)"
                         skip
                         with frame f-mostra.
                    find estab where estab.etbcod = integer(credscore.campo)
                                             no-lock no-error.
                    if not avail estab
                    then do:
                ...
                then do with frame f-credscore.
                    pause 0.                
                     disp
                         credscore.campo  label "Estab. Cliente"
                         skip
                         credscore.tipo-vl  label  "Perc/Val"
                         skip
                         credscore.operacao   label "Dim/Som"
                ...
                then do with frame f-exclui  row 5 1 column centered
                    ...
                    find next credscore use-index credint2
                        where credscore.desc-campo = "ESTABCLI"
                        no-error.
                    if not available credscore
                    then do:
...
procedure frame-a.
display credscore.campo  column-label "Estab." format "x(5)"
        credscore.tipo-vl 
        credscore.operacao 
        credscore.valor
        credscore.consnumparc
...
credscorelog.campo          = ant-campo + " ESTABCLI".
