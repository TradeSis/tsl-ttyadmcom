...
def var vcodtm as int init 5.

form tabmeta.etbcod
     estab.etbnom
     tabmeta.val_meta format ">>>,>>9.99"
     help "Informar Val_Meta em quantidade de garantia."
     with frame f-mcp
     title " Garantia "
...
l1: repeat:
    ...
    {sklcls.i  
        ...
        &aftfnd1 = " find estab where
                          ...
                          no-lock no-error.
                   "       
        &where  = " tabmeta.codTM = vcodtm and
...
procedure inclui-tabmeta:
    find tabmeta where tabmeta.codtm  = vcodtm and
                   tabmeta.anoref = p-ano and
...
procedure cal-total-meta:
    total_meta = 0.
    for each tabmeta where tabmeta.codtm  = vcodtm and
                   tabmeta.anoref = p-ano and
                   tabmeta.mesref = p-mes and
                   tabmeta.diaref = 0 
                   no-lock:
