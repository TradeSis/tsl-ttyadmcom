    ...
    repeat with frame frame-a:
        ...
        then do:
                ...
                then do with frame frame-a on error undo.
                    ...
                    update etiqmov except etmovcod.
                end.
        end.
        if not esqvazio
        then do:
...
then  
    if esqascend  
    then  
        find first etiqmov where true
                                                no-lock no-error.
    else  
        find last etiqmov  where true
                                                 no-lock no-error.
...
then  
    if esqascend  
    then  
        find next etiqmov  where true
                                                no-lock no-error.
    else  
        find prev etiqmov   where true
                                                no-lock no-error.
