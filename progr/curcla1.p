...
/******/    
        ...
        **/
        ...
        for each movim where movim.procod = produ.procod and
            ...
            then do:
                ...
                then next.
                if plani.crecod = 1
                then vlcontrato = plani.platot - plani.vlserv.
                else vlcontrato = plani.biss.
    ...
    disp categoria.catcod label "Departamento"
         ...
         xclase.clacod 
         xclase.clanom no-label with frame f-dep2 side-label width 200.
