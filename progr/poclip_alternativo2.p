...
def var placod	like contrato.crecod.
def var planom	like finan.finnom format "x(25)".
...
repeat:
    ...
    then do: 
	   ...
	   /** FIM **/
		    ...
		    placod	column-label "Cod. Plano"
		    planom	column-label "Nome Plano"
                                                    with width 300.
