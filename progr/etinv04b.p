...
if opsys = "UNIX"
then do:
    output to /admcom/zebra/04/eti-04.bat append.
    ...
    output to l:~\zebra~\04~\eti-04.bat append.
...
input close.
    ...
    then do:
      for each wfetq break by linha:
        ...
        if opsys = "UNIX"
        then varquivo = "/admcom/zebra/04/c" + string(produ.procod)
                               + "." + trim(string(par-taman,"x(3)")).
        else varquivo = "l:~\zebra~\04~\c" + string(produ.procod) 
                       + "." + trim(string(par-taman,"x(3)")).
        ...
        output close.
        if opsys = "UNIX"
        then varquivo = "/admcom/zebra/04/eti-04.bat".
        else varquivo = "l:~\zebra~\04~\eti-04.bat".
    ...
    then do:
      for each wfetq break by linha:
        ...
        if opsys = "UNIX"
        then varquivo = "/admcom/zebra/04/cr" + string(produ.procod) + 
                            "." + trim(string(par-taman,"x(3)")).
        else varquivo = "l:~\zebra~\04~\cr" + string(produ.procod) +
                            "." + trim(string(par-taman,"x(3)")).
        output to value(varquivo). 
