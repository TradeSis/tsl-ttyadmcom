...
then do:
    ...
    then put "X|" X01_transp.modfrete "|".
    else put "X|1|". 
    put skip.
    ...
    then do:
        ...
        */
        ...
        if X01_transp.placa <> ""
        then do:
            put "X18|" X01_transp.placa "|" X01_transp.uf "|".
            if X01_transp.rntc <> ""
            then put X01_transp.rntc "|".
            else put "|". 
            put skip.
        end.    
...
for each Z01_infadic of A01_infnfe no-lock:
    ...
    then.
    put "Z||" trim(Z01_infadic.obscont) "|" skip.
