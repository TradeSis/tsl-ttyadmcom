        ...
        for each tit_novacao where
            ...
            then do: 
                find first envfinan where
                               envfinan.empcod = ntitulo.empcod and
                               envfinan.titnat = ntitulo.titnat and
                               envfinan.modcod = ntitulo.modcod and
                               envfinan.etbcod = ntitulo.etbcod and
                               envfinan.clifor = ntitulo.clifor and
                               envfinan.titnum = ntitulo.titnum and
                               envfinan.titpar = ntitulo.titpar
                               no-lock no-error.
                if avail envfinan
