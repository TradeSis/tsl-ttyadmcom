...
for each titulo where   titulo.empcod = 19 and
    ...
    /*find first clasopnw where
                   clasopnw.dtvisao = vdatref and
                   clasopnw.tpvisao = "gerencial" and
                   clasopnw.cobcod  = tt-con.cobcod and
                   clasopnw.modcod  = titulo.modcod and
                   clasopnw.riscon  = "A" and
                   clasopnw.etbcod  = titulo.etbcod and
                   clasopnw.clifor  = titulo.clifor and
                   clasopnw.titnum  = titulo.titnum 
                   no-error.
    if not avail clasopnw
    then*/ do:
        p-catcod = 0.
        ...
        create clasopnw.
        assign
            clasopnw.dtvisao  = vdatref
            clasopnw.tpvisao  = "gerencial"
            clasopnw.modcod   = titulo.modcod
            clasopnw.etbcod   = titulo.etbcod
            clasopnw.etbcod   = titulo.etbcod
            clasopnw.clifor   = titulo.clifor
            clasopnw.titnum    = titulo.titnum
            clasopnw.titdtemi = titulo.titdtemi
            clasopnw.principal = p-principal
            clasopnw.renda     = p-renda
            clasopnw.vencido   = p-vencido
            clasopnw.vencer    = p-vencer
            clasopnw.qtdpar    = p-qtdpar
            clasopnw.qtdparab  = p-qtdparab
            clasopnw.matraso   = p-atraso
            clasopnw.catcod    = p-catcod
            clasopnw.riscon    = p-risco
            clasopnw.cobcod    = tt-con.cobcod
            .
        if avail contrato and contrato.vltotal = p-total
        then assign
                clasopnw.vltotal = contrato.vltotal
                clasopnw.vlentra = contrato.vlentra
                .
        else assign
                clasopnw.vltotal = p-total
                clasopnw.vlentra = p-entra
                    .
                         
        assign
            clasopnw.ven-999999 = pven-9999
            clasopnw.ven-5400 = pven-5400
            clasopnw.ven-1800 = pven-1800
            clasopnw.ven-1080 = pven-1080
            clasopnw.ven-360  = pven-360
            clasopnw.ven-90   = pven-90
            .

        assign
            tt-con.principal = clasopnw.principal
            tt-con.acrescimo = clasopnw.renda
            tt-con.vencido   = clasopnw.vencido
            tt-con.vencer    = clasopnw.vencer
            tt-con.risco     = clasopnw.riscon
            tt-con.valaberto = clasopnw.vencido + clasopnw.vencer
            tt-con.qtdparab  = clasopnw.qtdparab
        ...
        /****************************
        find first prodevnw where
                   prodevnw.data_visao = vdatref and
                   prodevnw.tipo_visao = "gerencial" and
                   prodevnw.cobcod     = tt-con.cobcod and
                   prodevnw.categoria  = 0 and
                   prodevnw.modalidade = "" and
                   prodevnw.faixa_risco = p-risco 
                   no-error.
        if not avail prodevnw
        then do:
            create prodevnw.
            assign
                prodevnw.data_visao = vdatref 
                prodevnw.tipo_visao = "gerencial" 
                prodevnw.cobcod     = tt-con.cobcod 
                prodevnw.categoria  = 0 
                prodevnw.modalidade = "" 
                prodevnw.faixa_risco = p-risco
                .
        end. 
        assign
            prodevnw.vencidos = prodevnw.vencidos + clasopnw.vencido
            prodevnw.vencer_9999 = prodevnw.vencer_9999 + pven-9999
            prodevnw.vencer_5400 = prodevnw.vencer_5400 + pven-5400
            prodevnw.vencer_1800 = prodevnw.vencer_1800 + pven-1800
            prodevnw.vencer_1080 = prodevnw.vencer_1080 + pven-1080
            prodevnw.vencer_360  = prodevnw.vencer_360  + pven-360
            prodevnw.vencer_90   = prodevnw.vencer_90   + pven-90
            prodevnw.principal   = prodevnw.principal   + clasopnw.principal
            prodevnw.renda       = prodevnw.renda       + clasopnw.renda
            prodevnw.saldo_curva = prodevnw.saldo_curva +
                                   clasopnw.vencido +
                                   pven-90 +
                                   pven-360 +
                                   pven-1080 +
        ...
        find first tt-tbcntgen where tt-tbcntgen.nivel = p-risco no-error.
        prodevnw.descricao_faixa =  tt-tbcntgen.numini + "-" +
                                    tt-tbcntgen.numfim.
        prodevnw.provisao = prodevnw.saldo_curva * (tt-tbcntgen.valor / 100).
        prodevnw.pctprovisao = tt-tbcntgen.valor.
        ***/                  
    end.
end.
...
for each tt-con:
    find first prodevnw where
                   prodevnw.data_visao = vdatref and
                   prodevnw.tipo_visao = "GERENCIAL" and
                   prodevnw.modo_visao = "CONTRATO"  and
                   prodevnw.cobcod     = tt-con.cobcod and
                   prodevnw.categoria  = 0 and
                   prodevnw.modalidade = "" and
                   prodevnw.faixa_risco = tt-con.risco 
                   no-error.
    if not avail prodevnw
    then do:
            create prodevnw.
    ...
    assign
            prodevnw.vencidos = prodevnw.vencidos + tt-con.vencido
            prodevnw.vencer_9999 = prodevnw.vencer_9999 + tt-con.ven-9999
            prodevnw.vencer_5400 = prodevnw.vencer_5400 + tt-con.ven-5400
            prodevnw.vencer_1800 = prodevnw.vencer_1800 + tt-con.ven-1800
            prodevnw.vencer_1080 = prodevnw.vencer_1080 + tt-con.ven-1080
            prodevnw.vencer_360  = prodevnw.vencer_360  + tt-con.ven-360
            prodevnw.vencer_90   = prodevnw.vencer_90   + tt-con.ven-90
            prodevnw.principal   = prodevnw.principal   + tt-con.principal
            prodevnw.renda       = prodevnw.renda       + tt-con.acrescimo
            prodevnw.saldo_curva = prodevnw.saldo_curva +
                                   tt-con.vencido +
                                   tt-con.ven-90 +
                                   tt-con.ven-360 +
        ...
        prodevnw.descricao_faixa =  tbcntgen.numini + "-" +
                                    tbcntgen.numfim.
        prodevnw.provisao = prodevnw.saldo_curva * (tbcntgen.valor / 100).
        prodevnw.pctprovisao = tbcntgen.valor.
...
for each tt-cli:
    find first prodevnw where
                   prodevnw.data_visao = vdatref and
                   prodevnw.tipo_visao = "GERENCIAL" and
                   prodevnw.modo_visao = "CLIENTE"  and
                   prodevnw.cobcod     = tt-cli.cobcod and
                   prodevnw.categoria  = 0 and
                   prodevnw.modalidade = "" and
                   prodevnw.faixa_risco = tt-cli.risco 
                   no-error.
    if not avail prodevnw
    then do:
            create prodevnw.
            assign
                prodevnw.data_visao = vdatref 
                prodevnw.tipo_visao = "GERENCIAL"
                prodevnw.modo_visao = "CLIENTE" 
                prodevnw.cobcod     = tt-cli.cobcod 
                prodevnw.categoria  = 0 
                prodevnw.modalidade = "" 
                prodevnw.faixa_risco = tt-cli.risco
                .
    ...
    assign
            prodevnw.vencidos = prodevnw.vencidos + tt-cli.vencido
            prodevnw.vencer_9999 = prodevnw.vencer_9999 + tt-cli.ven-9999
            prodevnw.vencer_5400 = prodevnw.vencer_5400 + tt-cli.ven-5400
            prodevnw.vencer_1800 = prodevnw.vencer_1800 + tt-cli.ven-1800
            prodevnw.vencer_1080 = prodevnw.vencer_1080 + tt-cli.ven-1080
            prodevnw.vencer_360  = prodevnw.vencer_360  + tt-cli.ven-360
            prodevnw.vencer_90   = prodevnw.vencer_90   + tt-cli.ven-90
            prodevnw.principal   = prodevnw.principal   + tt-cli.principal
            prodevnw.renda       = prodevnw.renda       + tt-cli.acrescimo
            prodevnw.saldo_curva = prodevnw.saldo_curva +
                                   tt-cli.vencido +
                                   tt-cli.ven-90 +
                                   tt-cli.ven-360 +
