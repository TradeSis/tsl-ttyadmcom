...
form liped.pedtdc column-label "T" 
     ...
     dispro.disqtd column-label "Dis" format ">>>9"
...
repeat:
        ...
        then do: 
            ...
            then do:
                 ...
                 for each dispro where dispro.etbcod = estab.etbcod and 
                    ...
                    find first dliped where dliped.pedtdc = 5 and
    ...
    display liped.pedtdc
            ...
            vpronom   format "x(40)"
            west 
            dispro.disqtd when avail dispro
            liped.lipsep 
          ...
          then do:
            ...
            then do transaction:
                ...
                for each liped  where liped.pedtdc = 5 and
                    ...
                    else if xestoq.estatual > 0
                        and (xestoq.estatual - liped.lipsep) > 0
                    then assign vvalida-estoque = yes.

                end.
                
                if not vvalida-estoque
                then do:
                    message "Nenhum dos produtos possui estoque!"
