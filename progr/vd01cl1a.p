...
assign iClieSeg = 1410.

repeat:

run pi-limpa.

update iClieSeg label "Cliente"
       with frame f-1 side-labels 1 col 1 down
            row 8 col 15 title "CLIENTE".  
...
disp iClieSeg label "Cliente"
     clien.clinom
     with frame f-1.  

assign iClieSeg = iClieSeg + 1.
...
/* ------------------------------------------------------------------------- */
    ...
    disp  i-qtd-45            label "De 16 a 45 dias"
          i-qtd-46            label "Acima de 45 dias "
          de-cheque_devolvido label "Cheque Devolvido "
          with frame f-2 side-labels 1 col 1 down
            row 12 col 15 title "SITUACAO CLIENTE". 
      ...
      */
              ...
              then do:
                       disp tp-titulo.empcod
                            ...
                            tp-titulo.titdtven  
                            tp-titulo.titvlcob  
                            column-label "Vlr Cobr" form "->>,>>9,99"
                            tp-titulo.titsit.
              end.
      /*
      end.
