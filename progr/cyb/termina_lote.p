...
message "Criando interface" today string(time,"HH:MM:SS").
...
do vi = 7 to 1 by -1 .
    message today string(time,"HH:MM:SS") " Gerando Arquivo " ve_tipo[vi].
    ...
    message today string(time,"HH:MM:SS") " Gerou Arquivo " ve_tipo[vi].

end.
message "FIM arquivo" today string(time,"HH:MM:SS").
**/

message "AJUSTE" today time.
run cyb/ajuste.p (input p-today).
message "FIM AJUSTE" today time.
