...
message "FIM AJUSTE" string(time,"HH:MM:SS").
message "|".
message "|".
message "VAI GERAR PGTO BOLETO (v1702)" today  string(time,"HH:MM:SS").
run cyb/enviapgtoboleto_v1702.p.
message "VAI GERAR NEXT        (v1702)" today  string(time,"HH:MM:SS").
run cyb/envianextboleto_v1702.p.

message "FIM LOTE" today  string(time,"HH:MM:SS").
