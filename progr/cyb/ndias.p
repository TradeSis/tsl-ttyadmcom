            ...
            form
                ...
                estab.etbnom
                 with frame f-tab_ini color black/cyan
                      centered side-label row 10 1 col.
...
then  
    ...
    then  
        ...
        find last tab_ini  where tab_ini.parametro = par-parametro
                                no-lock no-error.
...
then  
    if esqascend  
    then  
        find next tab_ini  where tab_ini.parametro = par-parametro
                                no-lock no-error.
    else  
        find prev tab_ini  where tab_ini.parametro = par-parametro
                                no-lock no-error.
