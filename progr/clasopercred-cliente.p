...
disp "                     CLASSIFICACAO OPERACOES DE CREDITO       " 
...
procedure aftselect:
    ...
    THEN DO on error undo:
        ...
        run pro-clasopercred-cliente-bg.p.
    ...
    THEN DO on error undo:
        ...
        run pro-clasopercred-cliente-bc.p. 

        /*
        run provisao-devedores-duvidosos-bc.p.
        */
