...
def var vclicod    like agi.ag3.clfcod. 
...
repeat:
   ...
   do transaction:
       find first agi.ag3 where agi.ag3.consit = 0 
                        and agi.ag3.etbcod = int(vparam-fil)
                        and agi.ag3.clfcod <> 0  
                        exclusive no-wait no-error.

       if avail agi.ag3
       then do:
            if agi.ag3.aux-param2 <> "Recebe"
            then do:
            run cria-tt.
            
            vtipo = agi.ag3.tipo.
            if length(string(agi.ag3.etbcod)) > 2
            then vfilial = " filial" + string(agi.ag3.etbcod,"999").
            else vfilial = " filial" + string(agi.ag3.etbcod,"99").
        
         output to /admcom/logs/agi_new/connectam_new.p.log append.
        put "Achou Etbcod:  "  vfilial format "x(10)" skip.
        output close. 


            
            if agi.ag3.aux-param1 = ""
            then
                 v-arq   = string(vtipo,"99")
                         + string(agi.ag3.clfcod).
            else
                 v-arq   = string(vtipo,"99")
                         + string(agi.ag3.aux-param1).
                 
        os-command silent
  /home/drebes/scripts/job-scp-conn_new value(v-arq) value(vfilial) " &".
            if vtipo = 1
            then do:
                vtipo-aux = 15.
                ...
                unix 
  /home/drebes/scripts/job-scp-conn_new value(varq-aux) value(vfilial) " &". 
                vtipo-aux = 18.
                varq-aux  = string(vtipo-aux,"99")
                        + string(agi.ag3.clfcod).
  ...
  /home/drebes/scripts/job-scp-conn_new value(varq-aux) value(vfilial) " &".
            ...
            else if agi.ag3.aux-param2 = "Recebe"
            then do:
                vtipo = agi.ag3.tipo.
                if length(string(agi.ag3.etbcod)) > 2
                then vfilial = " filial" + string(agi.ag3.etbcod,"999").
                ...
                if agi.ag3.aux-param1 = ""
                then v-arq   = string(vtipo,"99") + string(agi.ag3.clfcod).
                else v-arq   = string(vtipo,"99") + string(agi.ag3.aux-param1).
...
procedure cria-tt.         
    ...
    then do:
        ...
        if length(string(agi.ag3.etbcod)) > 2
        then varquivo = varquivo + string(agi.ag3.etbcod,"999").
        else varquivo = varquivo + string(agi.ag3.etbcod,"99"). 
        varquivo = varquivo + "/" + string(agi.ag3.tipo,"99") + string(agi.ag3.clfcod).
    end.
    else do:
        varquivo = "/admcom/connect/retorna3/filial".
        if length(string(agi.ag3.etbcod)) > 2
        ...
        varquivo = varquivo + "/" + string(agi.ag3.tipo,"99") 
                                    + string(agi.ag3.aux-param1).
    end.
    ...
    then do:
      output to value(varquivo).
        ...
        for each fin.titulo use-index iclicod where 
                 ...
                 fin.titulo.clifor = agi.ag3.clfcod no-lock:
        ...
        for each dragao.titulo use-index iclicod
                 where dragao.titulo.empcod = 19
                   ...
                   and dragao.titulo.clifor = agi.ag3.clfcod
        ...
        for each fin.cheque where fin.cheque.clicod = agi.ag3.clfcod
      ...
      varquivo = varquivo + "/" + "15" + string(agi.ag3.clfcod).
      output to value(varquivo).
      for each tcampanha where
               tcampanha.clicod = agi.ag3.clfcod no-lock,
      ...
      varquivo = varquivo + "/" + "18" + string(agi.ag3.clfcod).
      for each tt-clien. delete tt-clien. end.
      output to value(varquivo).
      for each clien where
               clien.clicod = agi.ag3.clfcod no-lock:
               create tt-clien.
               buffer-copy clien to tt-clien.
      end.
      for each tt-clien where
               tt-clien.clicod = agi.ag3.clfcod :
            find clien where clien.clicod = tt-clien.clicod no-lock.
            /****
            if agi.ag3.etbcod = 1 or
               agi.ag3.etbcod = 60
            then do:
                vcalclim = 0.
                vpardias = 0.
                vdisponivel = 0.
                run /admcom/progr/calccredsc.p (input "",
                        input recid(clien),
                        output vcalclim,
                        output vpardias,
                        output vdisponivel).
            ...
            if agi.ag3.etbcod = 189  or
               ...
               agi.ag3.etbcod = 8 or
               agi.ag3.etbcod = 9 or
               agi.ag3.etbcod = 10 or
               agi.ag3.etbcod = 11 or
               agi.ag3.etbcod = 13 or
               agi.ag3.etbcod = 14 or
               agi.ag3.etbcod = 15 or
               agi.ag3.etbcod = 16 or
               agi.ag3.etbcod = 18 or
               agi.ag3.etbcod = 19 or
               agi.ag3.etbcod = 20 or
               agi.ag3.etbcod = 21 or
               agi.ag3.etbcod = 23 or
               agi.ag3.etbcod = 24 or
               agi.ag3.etbcod = 25 or
               agi.ag3.etbcod = 26 or
               agi.ag3.etbcod = 27 or
               agi.ag3.etbcod = 28 or
               agi.ag3.etbcod = 29 or
               agi.ag3.etbcod = 31 or
               agi.ag3.etbcod = 32 or
               agi.ag3.etbcod = 33 or
               agi.ag3.etbcod = 34 or
               agi.ag3.etbcod = 35 or
               agi.ag3.etbcod = 38 or
               agi.ag3.etbcod = 40 or
               agi.ag3.etbcod = 45 or
               agi.ag3.etbcod = 46 or
               agi.ag3.etbcod = 48 or
               agi.ag3.etbcod = 50 or
               agi.ag3.etbcod = 52 or
               agi.ag3.etbcod = 53 or
               agi.ag3.etbcod = 54 or
               agi.ag3.etbcod = 57 or
               agi.ag3.etbcod = 59 or
               agi.ag3.etbcod = 60 or
               agi.ag3.etbcod = 62 or
               agi.ag3.etbcod = 65 or
               agi.ag3.etbcod = 67 or
               agi.ag3.etbcod = 71 or
               agi.ag3.etbcod = 75 or
               agi.ag3.etbcod = 80 or
               agi.ag3.etbcod = 81 or
               agi.ag3.etbcod = 82 or
               agi.ag3.etbcod = 83 or
               agi.ag3.etbcod = 85 /*or
               agi.ag3.etbcod = 99 */
            then***/  do:
                vcalclim = 0.
                vpardias = 0.
      ...
      varquivo = varquivo + "/" + "19" + string(agi.ag3.clfcod).
      /**
      find first cpclien where
               cpclien.clicod = agi.ag3.clfcod no-lock no-error.
      if not avail cpclien   
      then do transaction:
          create cpclien.
          cpclien.clicod = agi.ag3.clfcod.
      end.
      **/      
      output to value(varquivo).
      for each cpclien where
               cpclien.clicod = agi.ag3.clfcod no-lock:
            export cpclien.
      end.         
      output close.
      ...
      varquivo = varquivo + "/" + "20" + string(agi.ag3.clfcod).
      output to value(varquivo).
      for each carro where
               carro.clicod = agi.ag3.clfcod no-lock:
            export carro.
      end.         
      output close.
    end.
      ...
      output to value(varquivo).
         ...
         then do:
             for each plani where plani.movtdc = 5
                              and plani.desti  = agi.ag3.clfcod no-lock:
                 export plani.
             ...
             assign vetbcod-nf = 0
                    ...
                    vdata-aux  = ""
                    vpladat-nf = ?
                    vetbcod-nf = int(substring(agi.ag3.aux-param1,1,3))
                    vnumero-nf = int(substring(agi.ag3.aux-param1,4,10))
                    vdata-aux  =
                            substr(agi.ag3.aux-param1,14,length(agi.ag3.aux-param1))
      ...
      output to value(varquivo).
         ...
         then do:
             for each fin.contrato where 
                      fin.contrato.clicod = agi.ag3.clfcod no-lock:
                 export fin.contrato.
             end.
         end.
         else do:
    ...
    if agi.ag3.tipo = 7 /*Pedid*/
    then do:
      output to value(varquivo).
         if agi.ag3.aux-param1 = ""
         then do:
            for each com.pedid where com.pedid.pedtdc = 3
                              and com.pedid.etbcod = agi.ag3.etbcod
            ...
            for each com.pedid where com.pedid.pedtdc = 3
                              ...
                              and com.pedid.modcod  = agi.ag3.aux-param1
                               no-lock:
                export com.pedid.        
            end.
         end.
    ...
    if agi.ag3.tipo = 9 /*Ass. Tec.*/
    then do:
      output to value(varquivo).
         for each adm.asstec where adm.asstec.etbcod = agi.ag3.etbcod no-lock:
            export adm.asstec.         
         end.
      output close.   
    end.
    
    if agi.ag3.tipo = 10 /* titulo - etbcod - dtven */
    then do:
        output to value(varquivo).
          if agi.ag3.aux-param1 <> ""
          then do:
            assign vdia1 = 0 vmes1 = 0 vano1 = 0
                   ...
                   vdia1 = int(substring(agi.ag3.aux-param1,4,2))
                   vmes1 = int(substring(agi.ag3.aux-param1,6,2))
                   vano1 = int(substring(agi.ag3.aux-param1,8,4))

                   vdia2 = int(substring(agi.ag3.aux-param1,12,2))
                   vmes2 = int(substring(agi.ag3.aux-param1,14,2))
                   vano2 = int(substring(agi.ag3.aux-param1,16,4)) 
            ...
            do vdata = vdtini to vdtfin:
                FOR each fin.titulo use-index titdtven
                              where fin.titulo.empcod = 19 
                                ...
                                and fin.titulo.etbcod   = agi.ag3.etbcod  
    ...
    if agi.ag3.tipo = 11 /*Cheque Presente.*/
    then do:
      output to value(varquivo).
         ...
         for each fin.titulo where fin.titulo.empcod = 19           
                               ...
                               and fin.titulo.titnum = agi.ag3.aux-param1
    ...
    if agi.ag3.tipo = 12    /**Contrato DRAGAO**/
    then do:
      output to value(varquivo).
         if agi.ag3.aux-param1 = ""
         then do:
             for each dragao.contrato where 
                      dragao.contrato.clicod = agi.ag3.clfcod no-lock:
    ...
    if agi.ag3.tipo = 13    /**titluc - despesas financeiras**/
    then do:
      output to value(varquivo).
         if agi.ag3.aux-param1 = ""
         then do:
             for each fin.titluc where
                      fin.titluc.etbcod = agi.ag3.etbcod and
    ...
    if agi.ag3.tipo = 14    /**tbprice **/
    then do:
      output to value(varquivo).
         if agi.ag3.aux-param1 <> ""
         then do:
             vtipo-price = "".
             vseri-price = agi.ag3.aux-param1.
             /* */
             ...
             then do:
                ...
                find first adm.tbprice where
                           adm.tbprice.etb_venda = 
                                int(substr(string(agi.ag3.aux-param1),1,3)) and
                           adm.tbprice.data_venda =
                             date(substr(string(agi.ag3.aux-param1),4,8)) and
                           adm.tbprice.nota_venda =
                                int(substr(string(agi.ag3.aux-param1),12,9))
                           no-lock no-error.
                if avail adm.tbprice
                then do:
                    export adm.tbprice.
                    ...
                    find first adm.tbcntgen where
                         ...
                         tbcntgen.etbcod = agi.ag3.etbcod no-lock no-error.
    ...
    if agi.ag3.tipo = 15    /**CRM-Campanha**/
    then do:
         /********
         if agi.ag3.aux-param1 <> ""
         then do:
             ...
             repeat:
                create tcampanha.
                import tcampanha.
                if tcampanha.clicod <> agi.ag3.clfcod
    ...
    if agi.ag3.tipo = 16    /**clitel**/
    then do:
      output to value(varquivo).
      for each clitel where clitel.clicod = agi.ag3.clfcod no-lock.
    ...
    if agi.ag3.tipo = 17    /**Estoque**/
    then do:
      def buffer bestoq for estoq.  
      def var vlipqtd like liped.lipqtd.
      find estoq where estoq.etbcod = 993 and
                         estoq.procod = agi.ag3.clfcod no-lock no-error.
      if avail estoq
      then do:
          find bestoq where bestoq.etbcod = 995 and
                            bestoq.procod = agi.ag3.clfcod no-lock no-error.
          create tt-estoq.
          ...
          find bestoq where bestoq.etbcod = agi.ag3.etbcod and
                            bestoq.procod = agi.ag3.clfcod no-lock no-error.
          if avail bestoq
          then  do:
            find last movim where 
                      movim.etbcod = agi.ag3.etbcod and
                      movim.movtdc = 5 and
    ...
    if agi.ag3.tipo = 18    /**clien**/
    then do:
        /**
      output to value(varquivo).
      for each clien where clien.clicod = agi.ag3.clfcod no-lock.
        export clien.
      end.  
      output close.
      ***/
    end.
    if agi.ag3.tipo = 19 /**cpclien**/
    then do:
       /**
      output to value(varquivo).
      for each cpclien where cpclien.clicod = agi.ag3.clfcod no-lock.
        export cpclien.
      end.  
      output close.
       **/
