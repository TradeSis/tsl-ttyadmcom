...
repeat:
    ...
    if opsys = "unix"
    then varq = "/admcom/audit/ent_" + trim(string(vetb,"x(3)")) + "_" +
                string(day(vdti),"99") +  
    ...
    else varq = "l:\audit\ent_" + trim(string(vetb,"x(3)")) + "_" +
                string(day(vdti),"99") + 
                string(month(vdti),"99") +  
                string(year(vdti),"9999") + "_" +  
                string(day(vdtf),"99") +  
    ...
    for each tipmov where tipmov.movtdc = 4 or
        ...
        for each estab where if vetbcod = 0
            ...
            */
            ...
            for each fiscal where fiscal.movtdc = tipmov.movtdc and
                ...
                then valicm = dec(substr(string(valicm,">>>>>>>9.999"),1,11)).
        ...
        /* 980-986 */   vmovalipi format "9999.99" 
        ...
        /* 1331-1400 */ " " format "x(70)" skip.
            ...
            /* 980-986 */   valor_ipi format "9999.99" 
    ...
    for each estab where if vetbcod = 0 
        ...
        for each tipmov where tipmov.movtdc = 6 or 
            ...
            each plani where plani.movtdc = tipmov.movtdc and 
                             ...
                             plani.datexp <= vdtf  exclusive-lock:
            if plani.numero = 0
            then next.
            ...
            ******/
            ...
            for each movim where movim.etbcod = plani.etbcod and
                                 ...
                                 movim.desti  = plani.desti no-lock:
    ...
    then do:
        for each fiscal where fiscal.movtdc = tipmov.movtdc and
            ...
            find  plani where plani.movtdc = fiscal.movtdc and
                                 ...
                                 plani.pladat = fiscal.plaemi and
            ...
            for each movim where movim.etbcod = plani.etbcod and
                                 ...
                                 no-lock.
                valoricms = valoricms + round(movim.movicms,2).
            end.                     
            if round(valoricms,2) <> plani.icms
            then assign
                     plani.icms = round(valoricms,2)
                     fiscal.icms = round(valoricms,2).           
        end.
    end.
end.    
