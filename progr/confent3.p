    ...
    for each plani where plani.datexp >= vdata1 and
        ...
        for each movim where movim.etbcod = plani.etbcod and
            ...
            do vdata-aux = plani.pladat to today:
                ...
                for each bmovim use-index datsai where
                    ...
                    find first bplani where bplani.etbcod = bmovim.etbcod and
                                           ...
                                           bplani.pladat = bmovim.movdat and
                                           bplani.movtdc = bmovim.movtdc
                                                        no-lock no-error.
                    if not available bplani
                    then next.
                
                    if bplani.crecod = 2
                    then do:
                        if bplani.biss > ( bplani.platot - bplani.vlserv) and
                           (bplani.platot - bplani.vlserv) >= 1
                        then acre = bplani.biss / 
                                    (bplani.platot - bplani.vlserv).
                    
                        if acre = ? then acre = 0.
                    
                        if bplani.biss < ( bplani.platot - bplani.vlserv) 
                        then des = (bplani.platot - bplani.vlserv) 
                                    / bplani.biss.
                        ...
                        if bplani.acfprod > 0
                        then acre = (bplani.platot + bplani.acfprod) 
                                                  / bplani.platot.
                    
                        if acre = ? then acre = 0.
                    
                        if bplani.descprod > 0
                        then des = bplani.platot / 
                        (bplani.platot - bplani.descprod).
                    ...
                    find estoq where estoq.etbcod = bmovim.etbcod and
                    ...
                    if acre > 0
                    then do:
                        if ( bmovim.movqtm * bmovim.movpc * acre ) - 
                            ( ( ( bmovim.movqtm * bmovim.movpc ) / 
                             bplani.platot ) * bplani.vlserv ) <> ?
                        then venda = venda + 
                            ( bmovim.movqtm * bmovim.movpc * acre ) - 
                            ( ( ( bmovim.movqtm * bmovim.movpc ) / 
                              bplani.platot ) * bplani.vlserv ).
                    ...
                    if des > 0
                    then do:
                        if ( bmovim.movqtm * bmovim.movpc / des ) - 
                          ( ( ( bmovim.movqtm * bmovim.movpc ) / 
                                bplani.platot ) * bplani.vlserv ) <> ?
                    
                        then venda = venda +
                             ( bmovim.movqtm * bmovim.movpc / des ) - 
                             ( ( ( bmovim.movqtm * bmovim.movpc ) / 
                                   bplani.platot ) * bplani.vlserv ).
            ...
            display
                ...
                movim.movpc  format ">>>,>>9.99" column-label "Pr.Unit"
