...
repeat:
    ...
    /**Promocao mes de maio - Dinheiro na mao do vendedor**/
        ...
        for each plani use-index pladat  
            ...
            if  plani.cxacod = vcxi /***caixa.cxacod***/ and 
               (plani.pedcod = 15 or plani.pedcod = 17 or  
                plani.pedcod = 19 or plani.pedcod = 23 or
                plani.pedcod = 93 or plani.pedcod = 94) 
            then do:   
    ...
    then do:
        ...
        {mdadmcab.i 
                ...
                &Tit-Rel   = 
                        """ PROMOCAO MES DE MAIO (BRINDE CARTAO PRESENTE) "" 
                             + string(vdata1) + "" ATE "" + string(vdata2) "
                &Width     = "80"
                &Form      = "frame f-cab"}

                    
        display " FILIAL : " estab.etbnom no-label
                skip(2)
                " PREMIO P/ VENDEDOR " 
