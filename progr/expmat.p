...
assign conta1 = 0 conta2 = 0 conta3 = 0 conta4 = 0
       conta5 = 0 conta7 = 0 contcli = 0 conttit = 0
       contcon = 0 contest = 0 contpro = 0 contpla = 0
       contmov = 0 conttit = 0.
...
do vreg = 2 to 24:
    ...
    assign conta1 = 0 conta2 = 0 conta3 = 0 conta4 = 0 conta5 = 0
           contcli = 0 conttit = 0 contcon = 0 conttit = 0 contest = 0
           contpro = 0 contpla = 0 contmov = 0.
    ...
    output close.
    output to value("..\export\cpd" + string(vregcod,"99") + "\expctr.d")
                                            append.
        put setbcod " " v-dtini " " v-dtfin skip.
    output close.
