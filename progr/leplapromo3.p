...
then do:
    ...
    */
    for each bctpromoc where 
             bctpromoc.dtinicio <= plani.pladat and
             bctpromoc.dtfim    >= plani.pladat and
             bctpromoc.linha = 0
             no-lock:
        
        for each ctpromoc where 
                 ctpromoc.sequencia = bctpromoc.sequencia and
                 ctpromoc.produtovendacasada = p-procod and
        ...
        */                             
        ...
        for each ctpromoc where 
                 ctpromoc.sequencia = bctpromoc.sequencia and
                 ctpromoc.probrinde = p-procod and
                            ctpromoc.linha > 0 /*and
                            ctpromoc.fincod > 0  */
                                     no-lock:
        /*                             
