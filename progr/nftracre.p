...
repeat:
    ...
    *******************/
    ...
    for each w-movim:
        ...
        then next.
        tt-plani.protot = 0.
        /*tt-plani.protot + (w-movim.movqtm * w-movim.movpc).*/
        tt-plani.platot = 0.
        /*tt-plani.platot + (w-movim.movqtm * w-movim.movpc).*/

        create tt-movim.
        ASSIGN tt-movim.movtdc = 24
    ...
    then do:
        ...
        then do:
            message color red/with
                "Item nao informado" view-as alert-box.
                
        end.
        else do:
            run manager_nfe.p (input "5602",
                               input ?,
                               output vok).
        end.
    end.
