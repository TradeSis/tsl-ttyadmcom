...
do:
    DO:
        ...
        */
        ...
        /* NF de Estorno precisa ter a base e valor de ICMS no totalizador
        tt-plani.bicms = 0.
        tt-plani.icms = 0.
        */
            ...
            then do:
                    ...
                    assign
                        ...
                        assign
                            ...
                            N01_icms.vicms = 
                                    N01_icms.vbc * (tt-movim.movalicms / 100).
                        else if tt-movim.movicms > 0
                        then N01_icms.vicms = tt-movim.movicms.
