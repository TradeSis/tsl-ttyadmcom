...
then  
    if esqascend  
    then   find first finan where finan.fincod < 1000 no-lock no-error.
    else   find last finan  where finan.fincod < 1000 no-lock no-error.
                                             
if par-tipo = "seg" or par-tipo = "down" 
then  
    if esqascend  
    then   find next finan  where finan.fincod < 1000 no-lock no-error.
    else   find prev finan   where finan.fincod < 1000 no-lock no-error.
             
if par-tipo = "up" 
then                  
    if esqascend   
    then    find prev finan where finan.fincod < 1000  no-lock no-error.
    else    find next finan where finan.fincod < 1000 no-lock no-error.
