...
def var v as int.
v = 0.
for each prof_1521 where of prof_1504 no-lock.
    v = v + 1.
end.
...
then do. 
    pause 0.
    find first prof_1521 where of prof_1504 no-lock.
    hide frame f-com1  no-pause. 
    hide frame f-com2  no-pause. 
    run itim/tprof_1703.p (input string(recid(prof_1521))). 
    pause 0.
