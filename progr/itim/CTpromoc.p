/* itim/CTpromoc.p */
{admcab.i}
def input parameter par-OFFER_ID  like ctpromoc.OFFER_ID.
...
init["  Consulta","  Imprime", ""]
            .
def var esqcom2         as char format "x(12)" extent 6
init["  Planos","  Filiais","  Produtos","  Mensagem","  ","  "].
...
disp  vano format "9999" label "Ano"
...
status default "CUSTOM Business Solutions              - F5 -> Solicitacoes".
    ...
    then find first ctpromoc  where
                    ...
                    /*ctpromoc.dtfim <= vdtf and*/
                    */
                    ctpromoc.OFFER_ID = par-OFFER_ID and
                    ctpromoc.linha = 0 
                    no-lock no-error.
    ...
    then do:
        message "Nenhuma Promocao Criada para Oferta"
                view-as alert-box. 
        do on error undo.
        leave.
        end.
