...
def var aux-custo like estoq.estcusto.
        ...
        for each estab where estab.etbcod >= vetbi and
            ...
            */
            ...
            if avail hiest and 
               ...
               hiest.hiemes = vmes 
            then aux-custo = hiest.hiepcf. 
            else aux-custo = estoq.estcusto.

            if produ.catcod = 31
            then vtot31 = (vqtd * aux-custo).
            if produ.catcod = 41
            then vtot41 = (vqtd * aux-custo).

            if produ.catcod <> 31 and
               produ.catcod <> 41
            then vtot35 = (vqtd * aux-custo). 
