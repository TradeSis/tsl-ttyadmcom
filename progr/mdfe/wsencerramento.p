...
message "Solicitando Encerramento " mdfe.mdfechave.
...
vmetodo = "MDFeEmissaoSolicitarEventoEncerramento".
vLOG    = "MDFe_" + string(mdfe.mdfenumero, "999999999").
    ...
    mdfe_dtenc = string(year(vdtenc),"9999") + "-" +
                 string(month(vdtenc),"99")  + "-" +
                 string(day(vdtenc),"99").
...
vxml = vxml + geraXmlNfe("Inicio", "envNotamax", "").
    ...
    vxml = vxml + geraXmlNfe("Tag", "dtEnc",  mdfe_dtenc). 
