...
def temp-table tt-digita
    field clacod like clase.clacod
    index ch_cla  is primary unique clacod. 
...
repeat:
    ...
    repeat:
        ...
        then do:
            ...
            create tt-digita.
            assign tt-digita.clacod = vclacod.
      ...
      /*
        ...
        */
        for each tt-digita no-lock:
           ...
           assign vclacod = tt-digita.clacod.
    ...
    repeat:
        ...
        */
        update vetbcodi label "Estab Inicial"
               vetbcodf label "Estab Final"
               with frame f-etb centered side-label color blue/cyan row 15.
        if vetbcodi > vetbcodf
        then do:
                message "Estab Inicial nao pode ser maior que Estab Final!"
                        view-as alert-box.
                undo, retry.        
        end.       
        if vetbcodi <> 0 and
        ...
        then do:
                assign ict      = 0
                       iconta   = 0.
                do ict = vetbcodi to vetbcodf: 
                   find estab where estab.etbcod = ict no-lock.
                   if not avail estab
                   then next.
            ...
            then do:
                ...
                for each estab where estab.etbcod <> 0 no-lock:
                    ...
                    message "Entrada invalida, verifique Estab digitado!"
                            view-as alert-box.
                    undo, retry.
            end.
        end.    
