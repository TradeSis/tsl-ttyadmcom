...
repeat:
    ...
    then do:
        ...
        message "Nenhum produto na situacao"    par-sit
                view-as alert-box.
        leave.
    end.        
    ...
    repeat with frame frame-a:
        ...
        then do:
            ...
            then do:
                ...
                then do with frame f-prodistr on error undo.
                    par-sit = "F".
                    recatu1 = ?.
                    leave.
                end.
                ...
                then do with frame f-prodistr on error undo.
                    find prodistr where
                            recid(prodistr) = recatu1 no-lock.
                    hide frame f-com1  no-pause. 
                    hide frame f-com2  no-pause.
                    pause 0.
                    run alcis/hprodistr.p (recid(prodistr)).
                    view frame f-com1. 
                    view frame f-com2.
                end.
