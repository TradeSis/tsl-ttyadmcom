...
for each ttitem.
    find first liped of pedid where liped.procod = int(ttitem.produto) 
                            no-error.
    if avail liped
    then do.
                liped.lipent = liped.lipent +
                               dec(ttitem.Quantidade) / 1000000000 .
                liped.lipsep = liped.lipent.
                liped.lipsit = "A" .
                liped.protip = "C" .
    end.
end.                        
