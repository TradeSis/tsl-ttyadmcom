    ...
    for each tt-cla no-lock:
        ...
        for each tt-catcod,         
            ...
            for each tt-estab:
                ...
                then do:
                    valest  = valest  + 
                              (vqtd /*estoq.estatual*/ * estoq.estvenda).
                    valcus  = valcus  + 
                              (vqtd /*estoq.estatual*/ * estoq.estcusto).
                    est-atu = est-atu + vqtd /*estoq.estatual*/.
...
then do:
    ...
    /*
    output to /admcom/custom/Claudir/clase-cve.txt.
    for each tt-cla.
        export tt-cla.
    end.
    output close.    
