        ...
        do vdata = vdti to vdtf:
            for each divpre where divpre.etbcod = estab.etbcod and
                ...
                */
                ...
                if ((divpre.premat - divpre.preven)
                     >= (divpre.premat * 20 / 100) )
                then next.
...
repeat:
    ...
    assign vdec-dif-per = (((divpre.premat - divpre.preven) * 100) / divpre.premat).          
...
/*        divpre.prefil column-label "Preco!Filial"  format ">,>>9.9" */
    ...
    repeat:
        ...
        assign vdec-dif-per = (((divpre.premat - divpre.preven) * 100) /
        divpre.premat).
...
procedure p-listagem:
    ...
    for each tt-divpre no-lock:
         ...
         */                           
         ...
         assign vdec-dif-per = (((divpre.premat
                                   - divpre.preven) * 100) / divpre.premat).          
