...
def shared var vcomcod     like compr.comcod.
...
form
    ttsetor.setcod                  column-label "Codigo"
    help "P = Informacoes Filiais"
    setor.setnom    format "x(16)"  column-label "Descricao"
...
form
    ttclase.clacod                    column-label "Codigo"
    help "P = Informacoes Filiais"
    clase.clanom    format "x(15)"    column-label "Descricao"
...
/***/
form
    ttnivel1.clacod                    column-label "Codigo"
    help "P = Informacoes Filiais"
    clase.clanom    format "x(15)"     column-label "Descricao"
...
form
    ttnivel2.clacod                  column-label "Codigo"
    help "P = Informacoes Filiais"
    clase.clanom    format "x(15)"   column-label "Descricao"
            ...
            repeat : 
                ...
                for each ttaux-produ:
                     ...
                     find first subcar where
                                subcar.subcod = procar.subcod no-lock no-error.
...
procedure imp-pro:
    ...
    if opsys = "UNIX"
    then varquivo = "/admcom/relat/perfven.x" + string(time).
