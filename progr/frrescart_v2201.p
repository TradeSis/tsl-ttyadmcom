...
repeat with frame f1:
    ...
    update vcre label "Cliente" colon 25
           ...
           vdti label "Data de"  colon 25 vdtf label "Ate"  
           skip(1).
...
procedure relatorio:
    ...
    if opsys = "UNIX"
    then varquivo = "../relat/frrescart_" + string(today,"99999999") + replace(string(time,"HH:MM:SS"),":","") +
                    "_" + string(vdtf,"99999999") + ".txt".
    else varquivo = "l:~\relat~\cartw" + string(time).
    ...
    */
    ...
    {mdadmcab.i
        ...
        &Nom-Rel   = ""frrescart1801"" /* #1 */
            ...
            &Tit-Rel   = """MOVIMENTO DA CARTEIRA POR FILIAL - "" + vheader "
            &Width     = "140"
            &Form      = "frame f-cabcab"}
