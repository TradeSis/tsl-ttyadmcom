...
repeat:
    ...
    then do:
        ...
        for each tt-forpaifi,
            ...
            assign vestdep = 0.
            for each estoq where (estoq.etbcod >= 990 or
                      estoq.etbcod = 993 or
                      estoq.etbcod = 900 or
            ...
            vqtdest = 0.
            for each cestab where cestab.etbcod < 990 and
