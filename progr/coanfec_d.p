...
message 1 vlpres titpag.titvlpag view-as alert-box.                            
                        ...
                        vlpres = vlpres +  titpag.titvlpag.
message 2 vlpres titpag.titvlpag view-as alert-box.                        
                        run Pi-Cria-Anali(input "titulo", input 4, 
                               input titpag.moecod, input titpag.titvlpag, 
                               input 1).
...
message d.titulo.titnum d.titulo.titpar d.titulo.clifor d.titulo.titnat d.titulo.moecod view-as alert-box.            
...
message 3 d.titulo.moecod bmoeda.moetit vlpres d.titulo.titvlcob view-as alert-box.                     
                end.    
                ...
                if v-gravou-ana = yes then
                vlpres = vlpres + d.titulo.titvlcob.
message 4 vlpres d.titulo.titvlcob view-as alert-box.                
            end.    
