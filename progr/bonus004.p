...
procedure p-gera-arquivo-grafica:
    ...
    if opsys = "UNIX"
    then varq = "/admcom/relat-crm/Arquivo-Bonus-" 
         + string(time)
         + ".csv".
    else varq = "l:\relat-crm\Arquivo-Bonus-"
         + string(time)
         + ".csv".
...
vdisponivel = 0.
   ...
   then do:
        ...
        for each tt-acao where tt-acao.marca <> " " no-lock:
            ...
            for each acao-cli where
                ...
                put unformatted 
                    ...
                    clien.clinom        format "x(38)"
                    ";"
                    clien.endereco[1]   format "x(39)"
                    ";"
                    clien.numero[1]     format ">>>>9"
                    ";"
                    clien.compl[1]      format "x(10)"
                    ";"
                    clien.bairro[1]     format "x(29)"
                    ";"  
                ...
                put ";" tt-limite.limite /*lim-calculado*/ format "->>>,>>9.99" .
                    ...
                    put ";" vultcmp ";" tt-limite.limdisp format "->>>,>>9.99".
    ...
    if opsys = "UNIX"
    then varq1 = "/admcom/relat-crm/Arquivo-Bonus-Criticas" 
         + string(time)
         + ".csv".
    else varq1 = "l:\relat-crm\Arquivo-Bonus-Criticas"
         + string(time)
         + ".csv".
