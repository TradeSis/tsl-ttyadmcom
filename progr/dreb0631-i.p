...
repeat:
    ...
    */
    ...
    do vdt = vdtini to vdtfin:
        disp "Processando... " vdt format "99/99/9999"
            with frame f-disp 1 down centered width 80
            no-label no-box color message.
        pause 0.    
        for each estab where if vetbcod = 0
            ...
            disp plani.etbcod plani.numero format ">>>>>>>>9"
            with frame f-disp.
            pause 0.
            ...
            ********************************************/
            ...
            for each tt-movim:
                ...
                if vcatcod <> produ.catcod then next.
                assign
                    val_acr = val_acr + tt-movim.acr-fin
                    val_des = val_des + tt-movim.movdes
                    valtotal = valtotal + tt-movim.movtot
                    valor-bonus = valor-bonus + tt-movim.bonus.
    ...
    then do:
        ...
        for each wfcomis break by wfcomis.etbcod 
            ...
            display if wfcomis.modcod = "VVI"
                ...
                wfcomis.vtot - wfcomis.bonus  column-label "Venda(i)"
                                /*"Venda(2)"*/
...
procedure devolucao-venda:
    ...
    for each estab where if vetbcod = 0
        ...
        for each ctdevven where
            ...
            disp "Processando... " cplani.pladat cplani.etbcod 
                cplani.numero format ">>>>>>>>9"
                with frame f-devol 1 down centered width 80
                    no-label no-box color message.
            pause 0.   
