...
repeat:
    ...
    if opsys = "unix"
    then varq = "/admcom/audit/sai_" + trim(string(vetb,"x(3)")) + "_" +
                string(day(vdti),"99") +  
    ...
    else varq = "l:\audit\sai_" + trim(string(vetb,"x(3)")) + "_" + 
                string(day(vdti),"99") +   
                string(month(vdti),"99") +   
                string(year(vdti),"9999") + "_" +  
                string(day(vdtf),"99") +   
                ...
                then do: 
                    ...
                    for each movim where movim.etbcod = plani.etbcod and
                        ...
                        if vopccod = "5202" or 
                           vopccod = "6202"
                        then do:
                            assign base_icms = ((movim.movicms /
                                                  movim.movalicms) * 100)
                        ...
                        (movim.movdes * movim.movqtm) format "9999999999999.99"                          " " format "x(1)"
