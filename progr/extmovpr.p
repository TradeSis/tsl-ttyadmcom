...
def output parameter vsal-ant as dec.
def output parameter vsal-ent as dec.
def output parameter vsal-sai as dec.
def output parameter vsal-atu as dec.
def output parameter vest-atu as dec.
