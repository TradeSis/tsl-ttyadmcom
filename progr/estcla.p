/**********
#01 - Claudir - Permitir espaço na descrição da classe
#02 - Claudir - Verifica se nova classe ja existe 
***********/
{admcab.i}
{setbrw.i}
...
def var vletrachr as int.
def var vespecial as log.
...
def var vclaper like clase.claper. 
def buffer inc-clase for clase.
def buffer sup-clase for clase.
def buffer alt-clase for clase.
def buffer com-clase for clase.
         
def var inc-clase-clacod like inc-clase.clacod.
...
/*
for each clase where clase.clagrau > 4:
    delete clase.
end.    
*/
...
l0: repeat:
    ...
    {sklclstb.i  
        ...
        &aftselect1 = " esqcom1[3] = ""  INCLUIR"".
                        esqcom1[2] = ""  ALTERAR"".
                        find first rclase where rclase.clacod = depto.clacod
                                   no-lock. 
                        run aftselect.
                        a-seeid = -1.
                        a-recid = recid(depto).
    ...
    l5: repeat:
        ...
        {sklclstb.i  
            ...
            &aftselect1 = " 
                        ...
                        if esqcom1[esqpos1] = ""  relatorios""
                        then next keys-loop.
                        else if esqcom1[esqpos1] = ""  ALTERA P""
                            then do:
                                find next produ where
                                    produ.catcod = int(subclasse.claper) and
                                    produ.clacod = subclasse.clacod 
                                    use-index catcla 
                                    no-lock no-error.
                                if avail produ
...
procedure inclui:
    ...
    do on error undo, retry:
        ...
        if vclanom = ""
        then undo.     
        /* TESTA OS CARACTERES ESPECIAIS */
        vespecial = no.
        do vt = 1 to length(vclanom).
            vletra      =  substring(vclanom,vt,1).
            vletrachr   = asc(vletra).
            if vletrachr = 32 or /*#01 TP29837398*/
               (vletrachr >= 48 and vletrachr <= 57) or
               (vletrachr >= 65 and vletrachr <= 90) or
               (vletrachr >= 97 and vletrachr <= 122)
            then. /* NORMAL */
            else vespecial = yes.
        end.
        if vespecial 
        then do:
            message "RETIRE ACENTOS CEDILHA e OUTROS CARACTERES ESPECIAIS".
            undo.
        end.
    ...
    then do:
        ...
        then do:
            repeat: /*#02*/
                ...
                /*#02*/
                find com-clase where com-clase.clacod = vclacod 
                        no-lock no-error.
                if avail com-clase
                then do:
                    if vclagrau = 1
                    then vclasup = vclasup + 1000000.
                    else if vclagrau = 2
                    then vclasup = vclasup + 10000.
                    else if vclagrau = 3
                    then vclasup = vclasup + 100.
                    else if vclagrau = 4
                    then vclasup = vclasup + 1.
                end.
                else leave.    
                /*#02*/    
            end.
            ...
            /*#02*/
            inc-clase-clacod = inc-clase.clacod.
            repeat:
                if vclagrau = 1
                ...
                then do:
                    if vclagrau = 1
                    then inc-clase-clacod = inc-clase-clacod + 1000000.
                    else if vclagrau = 2
                    then inc-clase-clacod = inc-clase-clacod + 10000.
                    else if vclagrau = 3
                    then inc-clase-clacod = inc-clase-clacod + 100.
                    else if vclagrau = 4
                    then inc-clase-clacod = inc-clase-clacod + 1.
                end.
                else leave. 
            end.
            /*#02*/
...
procedure alterar:
    ...
    do on error undo, retry:
        ...
        update vclaper format ">>9" label "Categoria"
                with frame f-inclui.
    end.
    if vclanom <> "" and
       vclanom <> ? and
