    ...
    then  do:
        ...
        then
            ...
            find first com.pedid where com.pedid.pedtdc = vpedtdc
                        ...
                        and (if vnumped > 0
                             then com.pedid.pednum = vnumped else true)
                        and (if vproped > 0
...
then do:     
    ...
    for each tt-tipoped where tt-tipoped.marca = "". delete tt-tipoped. end.    
...
/***             ***/
  ...
  for each tt-estab no-lock break by tt-estab.ordem:
     ...
     for each xpedid where xpedid.etbcod = ger.estab.etbcod 
        ...
        then do:  
         ...
         for each com.liped of xpedid no-lock.
            find xprodu where xprodu.procod = liped.procod no-lock.
            if xpedid.etbcod = 200 and
               xprodu.proipival = 1
            then next.   
            cont = cont + 1.
            /* #2 */
            if xprodu.catcod = 41 then next.
            /* #2 */
     ...
     for each tt-pav:   delete tt-pav. end.
    ...
    for each ttconj. delete ttconj. end.        
