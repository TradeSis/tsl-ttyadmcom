...
then do:
    ...
    then do:
        ...
        if schave <> "" 
        then dos silent value(schave + " " + varqsai). 
     ...
     then do: 
        ...
        then do: 
            output to ./imp . 
                put unformatted "mozilla $1 &" .
            output close.
            unix silent ./imp value(varqsai).    
        end.
        else do: 
...
procedure gera-fontes: 
    ...
    output to ./lp-anita.
        ...
        if schave <> "" 
        then put "echo -e ~"~\033~[1yc:" + 
                 schave + " c:/temp/~$2 ~\033~\0134~""  
                 format "x(75)" skip.
        else put "echo -e ~"~\033~[1yc:/editstr.bat 
                 c:/temp/~$2 ~\033~\0134~"" skip.
    output close.
