...
/*    
def var vescolha as char extent 2 format "x(20)"
    init[" Ceredit Score "," Bloqueio venda "].
    
disp vescolha with frame f-esc no-label.
choose field vescolha with frame f-esc.
*/

def var p-tipo as char.
p-tipo = "BLOQUEIOVENDA".
...
def var esqcom1         as char format "x(15)" extent 5
    initial ["","  ALTERA","  INCLUI","  FILIAIS","  BLOQUEIOS"].
...
procedure aftselect:
    ...
    if esqcom1[esqpos1] = "  bloqueios"
    then do:
        hide frame f-com1.
        run tabparam_bv.p(input tt-grupo.tipo,
                          input tt-grupo.codigo,
                          input tt-grupo.descri).
        view frame f-com1.
    end.
