...
procedure validar-meta:
    ...
    for each plani where plani.etbcod = estab.etbcod and
                         plani.movtdc = 5 and
                      /* (plani.serie = "V" or plani.serie = "3") and */
    ...
    for each btt-previa where btt-previa.etbcod = estab.etbcod:
        ...
        then do:
            ...
            then do:
                if not avail tvendfil or
                          tvendfil.moveis > int(tabaux.valor_campo)
        ...
        then do:
            ...
            then do:
                if not avail tvendfil or
                        tvendfil.moda > int(tabaux.valor_campo)
