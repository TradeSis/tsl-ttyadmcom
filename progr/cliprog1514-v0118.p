...
for each tt-valores where tt-valores.t1 = vtipo1 and
        ...
        then do:
            ...
            if tt-valores.t2 = "CP0" or tt-valores.t2 = "CP1"
            then do:
                vpassa = tt-valores.t1 + "EMPRESTIMO". 
                run cria-ttrel(vordem, 
                                "    EMPRESTIMO", 
                                vpassa,
                                tt-valores.valor,
            ...
            else if tt-valores.t2 = "CHQ"
            then do:
                vpassa = tt-valores.t1 + "CHEQUE". 
                run cria-ttrel(vordem,
                                "    CHEQUE",
                                vpassa,
                                tt-valores.valor,
            ...
            else if tt-valores.t2 = "VVI"
            then do:
                vpassa = tt-valores.t1 + "A-VISTA".
                run cria-ttrel(vordem, 
                                "    A-VISTA",
                                vpassa,
                                tt-valores.valor,
        ...
        then run cria-ttrel(vordem, 
                            "        " + tt-valores.t6, 
                            vpassa + tt-valores.t6,
                            tt-valores.valor,
                            no).
        else if first-of(tt-valores.t7)
        then run cria-ttrel(vordem, 
                            "            " + tt-valores.t7, 
                            vpassa + tt-valores.t6 + tt-valores.t7 +
                            tt-valores.t8,
                            tt-valores.valor,
                            no).
