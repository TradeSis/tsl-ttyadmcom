...
input from /admcom/progr/admcom95.ini no-echo.
repeat:
...
display "" with frame ff2
    ...
    display
        APLICATIVO.APLINOM at 20
            with frame frame-a v-down down centered no-labels
                color normal  row 5 width 60 no-box.
    ...
    repeat with frame frame-a:
        ...
        then do on error undo, retry on endkey undo, leave.
            ...
            if vok = yes
            then                
         run /admcom/progr/logmen1.p( input aplicativo.aplicod,input 0).
            hide all no-pause.
            view frame ff1.
            view frame ff2.
            view frame fc1.
