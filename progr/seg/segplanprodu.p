...
def new shared temp-table ttsegprodu no-undo serialize-name "produto"
...
repeat:
    ...
    repeat with frame frame-a:
        ...
        then do:                      
            ...
            run seg/segplan.p (input ttsegprodu.procod).
...
for each produ where    produ.indicegenerico contains "IDSEGURO#*" no-lock.    
    create ttsegprodu.    
