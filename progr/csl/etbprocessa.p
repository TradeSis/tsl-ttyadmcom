...
def var vopcao as log format "Sim/Nao" label "Estab Participa ".
    ...
    repeat with frame frame-a:
        ...
        then do:
            ...
            then do with frame f-tab_ini on error undo.
                ...
                if tab_ini.etbcod > 0
                then find estab of tab_ini no-lock.
            ...
            then do with frame f-exclui  row 10 1 column centered
                        on error undo.
                message "Confirma Exclusao de" tab_ini.etbcod "?"
                        update sresp.
                if not sresp
                then undo, leave.
                run leitura (input "down").
