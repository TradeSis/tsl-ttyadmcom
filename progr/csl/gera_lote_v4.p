...
def var ve_programa as char extent 7 init
    ["csl/man_cadastro_v3.p", /* #4 */
     "csl/carga_contrato_v3.p",
     "csl/man_finan.p",
     "csl/parcela.p",
     "csl/mercadorias.p",
     "csl/pagamentos_v2001.p",
     "csl/baixas.p"].
...
do vti = 1 to 6:
    ...
    for each cslog_controle where cslog_controle.situacao = ve_situacao[vti]
        ...
        create c_contrato.
        c_contrato.contnum = cslog_controle.contnum.
        ...
        do vi = 1 to 7.
            ...
            if vok = no then next.
            create t_contrato.
            t_contrato.contnum = cslog_controle.contnum.
...
run csl/ajuste.p (input p-today).
