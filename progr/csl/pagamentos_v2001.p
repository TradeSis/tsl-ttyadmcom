...
for each cslog_controle where situacao = "PAGAR" or situacao = "BAIXAR" no-lock.
    ...
    then do.
        ...
        do vloop = 1 to     num-entries(vpagamentos).
            ...
            then do:
                if titulo.titdtpag = ?
                then if titulo.dtultpgparcial <> ?
                     then vtitdtpag = formatadata(titulo.dtultpgparcial).
                     else vtitdtpag = "".
                else vtitdtpag = formatadata(titulo.titdtpag).
