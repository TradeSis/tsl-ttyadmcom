/* helio 12062023 - Demanda 344 Inclusão de filiais na regra de clientes adiplentes */
/* helio 24012023 - retirar testes de envio, irao subir todos */
...
/** #6 **/ /** 02.2019 Helio.Neto - Versao 4 - Inlcui Elegiveis Feirao */
    ...
    for each titulo where 
        ...
        /* helio 24012023 - retirado os filtros, sobem todos */
        if true /* helio - 16102023 47047 -Inclusão de clientes adimplentes Cslog - TODAS AS FILIAIS */
        then do:
        ...
        else do: /* helio 24012023 - retirado os filtros - mantem para as demais lojas ainda */
      ...
      do on error undo:
        find first titprotparc where titprotparc.operacao = "IEPRO" and
                                     titprotparc.contnum  = vcontnum and
