                ...
                */
                ...
                find first envfinan where 
                                  ...
                                  and envfinan.titnum = titulo.titnum
                                    no-lock no-error.
                if  avail envfinan or titulo.cobcod = 10
                then do:
                    vhist = "3 - COBRANCA".
                    find first tt-titulo where  tt-titulo.tipo = vhist 
                            and tt-titulo.etbcod = tt-estab.etbcod
...
def var vt-total as dec.
def var vt-juro as dec.
for each ctcartcl where
...
for each tt-titulo where  tt-titulo.tipo = "3 - JURO" 
    ...
    ctcartcl.dec2 = ctcartcl.dec2 + (tt-titulo.titvlcob * 100).
    vt-juro = vt-juro + tt-titulo.titvlcob.
end.

for each tt-titulo where  tt-titulo.tipo = "3 - COBRANCA" 
                   and tt-titulo.etbcod > 0
                   and tt-titulo.data <> ?
                    no-lock .
    find first ctcartcl where
    ...
    ctcartcl.dec2 = ctcartcl.dec2 + (tt-titulo.titvlcob * 100).
    vt-total = vt-total + tt-titulo.titvlcob.
end.


disp vt-total vt-juro. pause.
