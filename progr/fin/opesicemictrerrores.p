...
def  temp-table tterro no-undo
    field descerro  like sicred_contrato.descerro
    field qtd       as int
...
/*            help "Pressione L para Listar" */
        ...
        then do:
            ...
            then do:
                ...
                verro = tterro.descerro.
                 
                run fin/opesicemictrerro.p (pstatus,tterro.descerro).
                run montatt.
                find first tterro where tterro.descerro = verro no-error.
                if avail tterro
                then recatu1 = recid(tterro).
                else recatu1 = ?.
                leave.
            end.
...
/*        sicred_contrato.cobcod   = pcobcod   and*/
    ...
    find first tterro where tterro.descerro = sicred_contrato.descerro no-error.
    if not avail tterro
    then do:
        create tterro.
        tterro.descerro = sicred_contrato.descerro.
    end.
