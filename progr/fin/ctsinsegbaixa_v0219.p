...
def new shared temp-table tt-segpag like tbsegpag
...
unix silent value("cp " + varquivo + " " + vdir-bkpbaixa + " 2>/dev/null").
...
form 
     ...
     with frame f-linha 8 down color with/cyan /*no-box*/ row 6
     width 80.
...
procedure aftselect:
    ...
    THEN DO:
        ...
        hide frame f-com2.
        hide frame f-linha.
        run fin/ctsinsegbaixasobra_v0119.p(input par-recid-pdvmov, input varq-baixa). 
        pause 0.
        view frame f-linha.
        view frame f-com2.
        view frame f-com1.
...
def var vcpf as dec.
    for each tt-arqimp:
        ...
        vcpf = dec(replace(tt-arqimp.cpf,"-","")).
        find first clien where clien.ciccgc = replace(tt-arqimp.cpf,"-","")
                    no-lock no-error.
        if not avail clien 
        then do:
            ...
            then do:
                ...
                tt-arqimp.cliente = "CPF NAO ENCONTRADO".
                next.
            end.    
        end.    
            ...
            then do:
                ...
                then do:
                    ...
                    then do:
                        tt-arqimp.sit = "SOBRA".
                        /* helio 14122020 */
                        find first tt-segpag where tt-segpag.certificado =  tbsegpag.certificado  no-error.
                        if not avail tt-segpag
                        then do:
                            create tt-segpag.
