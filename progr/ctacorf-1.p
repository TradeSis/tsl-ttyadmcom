...
form contacor.etbcod    column-label "Fil"
     ...
     contacor.setcod    column-label "Set" format ">>9"
     setaut.setnom      column-label "Set. Nome" format "x(15)" 
     contacor.datemi    column-label "Data" format "99/99/99"
...
vtipo = caps(tt-contacor.campo3[1]).
...
then do:
  ...
  if not avail contacor
  then do:
    message "Nao ha Debitos tipo" vtipo "p/serem conciliados ! " skip
