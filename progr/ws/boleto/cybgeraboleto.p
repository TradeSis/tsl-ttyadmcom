...
bsxml("NomeWebService","cyberboleto").
    ...
    if not avail banBoleto or (avail banboleto and banboleto.situacao <> "R") 
    then do:
        ...
        BSXml("ABREREGISTRO","Boleto"). 
            ...
            bsxml("nossoNumero",if banboleto.bancod = 104
                                then banboleto.impnossonumero
                                else string(banBoleto.nossonumero,"99999999")).
            ...
            bsxml("sacadoNome",removeacento(clien.clinom)).
            bsxml("sacadoEndereco",removeacento(clien.endereco[1])).
            bsxml("sacadoCEP",string(clien.cep[1],"99999999")).
            bsxml("sacadoCidade",removeacento(string(clien.cidade[1]))).
