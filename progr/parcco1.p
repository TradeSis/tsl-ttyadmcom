...
for each btitulo where btitulo.empcod = tt-titulo.empcod
    ...
    display
        tt-titulo.titnum
        tt-titulo.titpar   format ">9" column-label "Fl"
        tt-titulo.titdtemi format "99/99/9999"   column-label "Dt.Emis"
        tt-titulo.titvlcob format ">>>,>>9.99" column-label "Vl Cobrado"
        tt-titulo.titdtven format "99/99/9999"   column-label "Dt.Vecto"
        tt-titulo.titdtpag format "99/99/9999"   column-label "Dt.Pagto"
