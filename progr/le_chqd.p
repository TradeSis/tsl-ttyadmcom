...
def new shared temp-table tt-licmc7
...
def new shared temp-table tt-dif-salva like tt-dif.
    ...
    */
    ...
    then do:
        ...
        repeat:
            ...
            */        
            ...
            create tt-licmc7.
            assign tt-licmc7.banco = int(vbanco)
                   tt-licmc7.agencia = int(vagencia)
                   tt-licmc7.conta   = vconta
                   tt-licmc7.numero = vnumero.
    ...
    for each tt-chq where tt-chq.vmarca = "".
     ...
     for each tt-dif :
        ...
        /*
        disp tt-dif-salva.banco tt-dif-salva.agencia                          tt-dif-salva.conta tt-dif-salva.numero tt-dif-salva.cmc7.
        */
     end.
     /**/
        ...
        for each chq where chq.datemi = tt-data.datmov no-lock.
            ...
            */
            ...
            find first tt-dif where 
                        ...
                        tt-dif.agencia = chq.agencia      and
                        tt-dif.conta   = chq.conta and
                        tt-dif.numero  = chq.numero  no-error.
             /**
            find first tt-dif where 
    ...
    then do:
        ...
        then do:
            for each tt-chq:
                ...
                find chq where recid(chq) = tt-chq.rec /*no-lock*/.
                /* #1 do transaction: */
                    chq.campo1 = tt-chq.cmc7.
                /* #1 end. */
                find current chq no-lock.
                ...
                then do /* #1 transaction */ :
                    ...
                    assign chqenv.recenv = int(recid(chq))
                           ...
                           chqenv.datenv = today
                           chqenv.chaenv = "COFRE"
                           chqenv.texto1 = chq.campo1.
                end.
                else do /* #1 transaction */ :
                    if chqenv.chaenv = ""
