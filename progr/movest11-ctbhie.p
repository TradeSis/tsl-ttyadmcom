...
find produ where produ.procod = vprocod no-lock.
    ...
    ***********/
    ...
    find last ctbhie where ctbhie.etbcod = vetbcod and
                           ctbhie.procod = produ.procod and
                           ctbhie.ctbano = 2010 no-lock no-error.
    if avail ctbhie
    then do:
        assign sal-ant = ctbhie.ctbest
                vmes    = ctbhie.ctbmes
                vano    = ctbhie.ctbano. 
        ...
        find last hiest where hiest.etbcod = vetbcod  and
                          hiest.procod = produ.procod and
                          hiest.hiemes = 12 and
                          hiest.hieano = 2010  no-error.
        if avail hiest
        then hiest.hiestf = sal-ant.
        else do:
            create hiest.
            assign
                hiest.etbcod = vetbcod
                hiest.procod = produ.procod
                hiest.hiemes = 12
                hiest.hieano = 2010
                hiest.hiestf = sal-ant
                .
        end.               
    end.                      
