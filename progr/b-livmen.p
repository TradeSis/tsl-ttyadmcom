...
for each admprog where admprog.menpro begins vdata no-lock.
    ...
    **/
    ...
    output to /admcom/connect/gerarel/livro-men. 
...
/admcom/connect/gerarel/livro-men > /admcom/connect/gerarel/livro-men.txt").

    os-command silent rm -f /admcom/connect/gerarel/livro-men.
 /*   os-command silent gzip -f /admcom/connect/gerarel/livro-men.txt.*/

    os-command silent /home/drebes/scripts/rcp-arq.sh enviar lista 
           /admcom/connect/gerarel/livro-men.txt /usr/admcom/connect/gerarel &.
