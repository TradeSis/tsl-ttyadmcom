          ...
          then do:
            ...
            then do with frame f-altera
               ...
               do on error undo, retry:        
                ...
                update cpforne.char-2 label "Email-NFe"
                            format "x(50)".
                update cpforne.log-1 label "Substituto"
                            format "Sim/Nao".
            end.
            ...
            then do with frame f-consulta
                ...
                disp
                     ...
                     cpforne.char-2 label "Email-NFe"
                            format "x(50)"
                     cpforne.log-1  label "Substituto" format "Sim/Nao"
            ...
            then do:
                ...
                */
                disp forne.forcod format ">>>>>>>>9" with frame f-print.
