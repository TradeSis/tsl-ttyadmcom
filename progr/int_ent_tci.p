...
repeat:
    ...
    then do:
        ...
        input from /file_server/param_etci.
        repeat:
            import varq.
    ...
    for each estab where if vetbcod = 0 
        ...
        if vopccod = "1949" and (movim.procod = 414803 or
                                 movim.procod = 418905)
        ...
        /* 2160      */     " " format "x(10)"
        /* 2170      */     " " format "x(20)"
        /* 2190      */     0 format "9999999999999.99"
        /* 2206      */     0 format "9999999999999.99"
        /* 2222      */     0 format "9999999999999.99"
        /* 2238      */     0 format "9999999999999.99"
        /* 2254      */     0 format "9999999999999.99"
        /* 2270      */     0 format "9999999999999.99"
                       /*     " " format "x(64)" */
        .
        ...
        put " " format "x"
            " " format "x(12)"
            0 format "9999999999999.99"
            0 format "9999999999999.99"
  /*2409*/  " " format "x(20)" 
  /*2429*/  0 format "999.99"
  /*2435*/  " "   format "x(10)"
  /*2445*/  " "   format "x(10)"          
            .
