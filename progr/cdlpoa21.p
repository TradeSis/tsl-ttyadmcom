...
varquivo = "/admcom/import/cdlpoa/cdlpoa-CRE-pag-" 
+ string(day(today))  
+ string(month(today))  
+ string(year(today))  
+  "-" + string(time) + ".csv".
...
varquivo2 = "/admcom/import/cdlpoa/cdlpoa-CRE-G2-lib-"
+ string(day(today))
+ string(month(today))
+ string(year(today))
+  "-" + string(time) + ".csv".
...
if (  substring(clien.ciccgc,8,1) = "4" or
      substring(clien.ciccgc,8,1) = "5" or
      substring(clien.ciccgc,8,1) = "6") then do:
