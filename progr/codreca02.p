...
do on error undo:
  ...
  do on error undo:
        ...
        for each rfvcli no-lock :
            ...
            if vkont modulo 1000 = 0 then
            disp "Fase 1 : " rfvcli.clicod no-label 
                             vkont label "Reg."
            with frame f-most centered no-box row 10 side-labels.
            pause 0.
        ...
        for each bestab 
           ...
           do vdt = vdatini to vdatfin:
               ...
               disp "Fase 2 : " vdt no-label bestab.etbcod no-label 
...
disp "" @ tt-ven.clicod
          ...
          with frame fmostraf no-label width 158 down.
