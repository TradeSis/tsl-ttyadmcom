/*
*
*    pdvmovim.p    -    Esqueleto de Programacao    com esqvazio
*
*/
{admcab.i}
...
def buffer bpdvmovim       for pdvmovim.
...
repeat:
    ...
    then do.
        message "Sem pdvmovim" view-as alert-box.
        leave.
    end.
    else esqvazio = no.
    ...
    repeat with frame frame-a:
        ...
        then do:
            ...
            then do:
                ...
                then do with frame f-pdvmovim on error undo.
                    create pdvmovim.
                    update pdvmovim.
                    recatu1 = recid(pdvmovim).
                    leave.
...
procedure frame-a.
    display
        pdvmovim.etbcod column-label "Etb"
        pdvmovim.movseq
        pdvmovim.procod 
        pdvmovim.movpc
        pdvmovim.movqtm
