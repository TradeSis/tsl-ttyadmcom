/*
    #1 03/2018 - Melhorias Neurotech Pacote 01 - 
               - Versionamento
*/    
...
def temp-table tt-tabparam like tabparam.
        ...
        then do:
            ...
            assign
                ...
                tt-tabparam.grupo  = p-grupo
                tt-tabparam.aplicacao = p-aplicacao
                tt-tabparam.parametro  = "QUANTIDADE DE NOVACOES FEITAS"
                tt-tabparam.valor      = 0
                tt-tabparam.condicao = ">"
                tt-tabparam.bloqueio   = no
                tt-tabparam.dtexp = today
            ...
            assign
                ...
                tt-tabparam.grupo  = p-grupo
                tt-tabparam.aplicacao = p-aplicacao
                tt-tabparam.parametro  = "VALOR DE NOVACOES EM ABERTO"
                tt-tabparam.valor      = 0
                tt-tabparam.condicao = ">"
                tt-tabparam.bloqueio   = no
                tt-tabparam.dtexp = today
            ...
            assign
                ...
                tt-tabparam.grupo  = p-grupo
                tt-tabparam.aplicacao = p-aplicacao
                tt-tabparam.parametro  = "DIAS DE ATRASO ATUAL"
                tt-tabparam.valor      = 0
                tt-tabparam.condicao = ">"
                tt-tabparam.bloqueio   = no
                tt-tabparam.dtexp = today
            ...
            assign
                ...
                tt-tabparam.grupo  = p-grupo
                tt-tabparam.aplicacao = p-aplicacao
                tt-tabparam.parametro  = "CHEQUE DEVOLVIDO ABERTO"
                tt-tabparam.valor      = 0
                tt-tabparam.condicao = ">"
                tt-tabparam.bloqueio   = no
                tt-tabparam.dtexp = today
