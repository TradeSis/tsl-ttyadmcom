...
def temp-table tt-mes no-undo
    ...
    var-parcpagdb = 0.
    vetblimdisp = ?.
    def var n-disponivel as char init "NAO".
...
/* 10.11.2017, descoberto que ADMCOM tem tabelas para somar coisas velhas */     
    ...
    var-sallimite = neuclien.vlrlimite - var-salabprinc.
...
/*    pega_prop("DTCADASTRO")     vsep */
    ...
    + "#LIMITETOM="  + string(var-salaberto)
    + "#LIMITETOMPR="  + string(ROUND(var-salabprinc, 2))
    + "#LIMITEDISP=" + string(var-sallimite)
