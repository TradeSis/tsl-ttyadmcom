...
then do:
    esqcom1[1] = "<filtrar>".
    create ttfiltros.
    run finct/trocbarusel.p /*(input vcobcodori,
                           input vcobcoddes)*/.
end.
    ...
    repeat with frame frame-a:
        ...
        then do:
            ...
            then do: 
                ...
                if true /*vcobcoddes = 14 or vcobcoddes = 16 */
                then do:
                    message "confirma gerar arquivo para BARU?" update sresp.
                    if sresp
                    then  run finct/trocbaruenvia.p. 
                    return.
                end.
