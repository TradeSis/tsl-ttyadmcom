...
def temp-table tt-promo
    ...
    field venda31 as dec
    field venda41 as dec
...
for each estab where (if vetbcod > 0
    ...
    */
    ...
    for each movim where movim.etbcod = plani.etbcod and
        ...
        if produ.catcod = 31
        then tt-promo.venda31 = tt-promo.venda31 +
                    (movim.movpc * movim.movqtm).
        else tt-promo.venda41 = tt-promo.venda41 + 
                    (movim.movpc * movim.movqtm).
    end.   
    if vok
    then do:
...
for each tt-promo where tt-promo.venda41 > tt-promo.venda31:
    delete tt-promo.
end.    
def var vi as dec.
for each tt-promo:
    ...
    */
    ...
    if tt-promo.pct-promo > 39.99 and
       tt-promo.pct-promo < 40
    then tt-promo.pct-promo = 40.

    if tt-promo.pct-promo >= 40
    then tt-promo.premiog = 100.
    
    if tt-promo.pct-promo >= 50
    then tt-promo.premiog = 200.
    
    if tt-promo.pct-promo >= 60    
    then tt-promo.premiog = 300. 
  
    if tt-promo.pct-promo >= 70
    then tt-promo.premiog = 400.
        
    if tt-promo.pct-promo >= 80
...
repeat:
    ...
    display tt-promo.etbcod column-label "Fil"   
            ...
            /**
            tt-promo.val-venda  column-label "Valor!venda"
            tt-promo.val-promo  column-label "Valor!Promo"
            **/
