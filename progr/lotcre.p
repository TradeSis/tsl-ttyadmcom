...
def var esqcom1         as char format "x(14)" extent 5
            initial [" Novo Lote "," Clientes "," "," Consulta "," Relatorio "].
def var esqcom2         as char format "x(14)" extent 5
            initial [" Validacao"," Gera Remessa"," Retorno "," ",""].
...
find first lotcretp where lotcretp.ltcretcod = par-lotcretp no-lock no-error.
if not avail lotcretp
then do:
    bell.
    message color red/with
    "Lotcretp não encontrado para " par-lotcretp
    view-as alert-box.
    return.
end.    
if lotcretp.titnat
    ...
    repeat with frame frame-a:
        ...
        then do:
            ...
            then esqcom2[3] = " Retorno ".
                ...
                find first lotcretit of lotcre where
                        lotcretit.lottitpag  = ? no-lock no-error.
                if avail lotcretit
                then esqcom2[3] = " Retorno ".
                else esqcom2[3] = "".
            end.
            ...
            if (lotcre.ltdtvalida <> ? and
               lotcre.ltdtenvio <> ?  and
               lotcre.ltdtretorno = ?) or
               lotcre.Arqretorno = "CANCELADO"
            then do:
                esqcom2[1] = "Valida arquivo".
                esqhel2[1] = "Valida arquivo".
                esqcom2[2] = " Excluir Envio ".
                esqhel2[2] = " Excluir lote enviado ". 
                 
            end.
            else esqcom2[1] = "".

            if lotcre.ltdtretorno <> ?
            then assign
                    esqcom2[4] = " Rel.Retorno "
                    esqcom2[5] = " Gera CTB "
                    .
            
            /**********
            if lotcretp.ltcretcod = "ACCESS" or ltcretcod = "GLOBAL"
            then do:
                esqcom2[4] = " Rel.Retorno ".
            end.

            if lotcre.ltdtenvio <> ? and lotcretp.ltcretcod = "ACCESS"
            then assign 
                    esqcom2[5] = "Atuali.Cadastro"
                    esqhel2[5] = "Atualiza Cadastro".
            else assign
                    esqcom2[5] = ""
                    esqhel2[5] = "".
            ***************/        
               ...
               /* display caps(esqcom1[esqpos1]) @ esqcom1[esqpos1]
                ...
                then do with frame f-lot centered row 5 side-label:
                    ...
                    disp
                       ...
                       lotcre.arqenvio     colon 12 no-label
                       skip(1)
...
***/
                ...
                if esqcom2[esqpos2] = " Gera CTB "
                then do:
                    hide frame f-com1  no-pause.
                    hide frame f-com2  no-pause.
                    run gera-lan-caixa.p  (input "LOTE",
                                           input recid(lotcre)).
                    view frame f-com1.
                    view frame f-com2.
                    leave.
                ...
                if esqcom2[esqpos2] = "Valida arquivo"
                then do.
...
procedure frame-a.
    ...
    find lotcretp of lotcre no-lock.
    /*
    message lotcre.arqretorno lotcre.arqenvio lotcre.ltdtenvio.
    pause.
    */
    vtipo = "".
        ...
        then vtipo = "".
        if lotcre.Arqretorno <> "" and
           lotcre.Arqretorno <> "Cancelado"
        then vtipo = "C/Retorno".
        else vtipo = lotcre.Arqretorno.
    ...
    display
        ...
        lotcre.ltdtenvio
        /*lotcre.ltdtvalida*/
        lotcre.ltcreret column-label "Dt.Pag."
        lotcre.ltselecao format "x(20)"
