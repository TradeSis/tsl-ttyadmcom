/* helio 14092023  ID 44709 - Script pgtosap. não deve levar a moeda BAO */
...
do vtoday = vdtini to today:
    ...
    for each cmon no-lock.
            /* helio 14092023 */
        for each pdvtmov where pdvtmov.expsap = yes and NOT (pdvtmov.ctmcod = "AOB" or pdvtmov.ctmcod = "BAO") no-lock.
